...
#Region "Parser"
    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseBINARYFACTTYPEANYNUMBEROFCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: BINARYFACTTYPEANYNUMBEROFCLAUSE
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: BINARYFACTTYPEANYNUMBEROFCLAUSE

        Private Sub ParseBINARYFACTTYPEATLEASTONECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: BINARYFACTTYPEATLEASTONECLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: BINARYFACTTYPEATLEASTONECLAUSE
        ...
        Private Sub ParseDATATYPEPRECISIONANDSCALE(ByVal parent As ParseNode) ' NonTerminalSymbol: DATATYPEPRECISIONANDSCALE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: DATATYPEPRECISIONANDSCALE
        ...
        Private Sub ParseFACTCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: FACTCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: FACTCLAUSE
            ...
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.KEYWDANYNUMBEROF
                    ParseBINARYFACTTYPEANYNUMBEROFCLAUSE(node) ' NonTerminal Rule: BINARYFACTTYPEANYNUMBEROFCLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
                Case TokenType.KEYWDATLEASTONE
                    ParseBINARYFACTTYPEATLEASTONECLAUSE(node) ' NonTerminal Rule: BINARYFACTTYPEATLEASTONECLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
        ...
        Private Sub ParseIDENTIFIERMODELELEMENT(ByVal parent As ParseNode) ' NonTerminalSymbol: IDENTIFIERMODELELEMENT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: IDENTIFIERMODELELEMENT
        ...
        Private Sub ParseISOBJECTIFIEDCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: ISOBJECTIFIEDCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: ISOBJECTIFIEDCLAUSE

        Private Sub ParseISWHERECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: ISWHERECLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: ISWHERECLAUSE
        ...
        Private Sub ParseMODELELEMENT(ByVal parent As ParseNode) ' NonTerminalSymbol: MODELELEMENT
            ...
            End If
             ...
             ' Concat Rule
            ParseQUOTEDMODELELEMENTNAME(node) ' NonTerminal Rule: QUOTEDMODELELEMENTNAME
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
        ...
        Private Sub ParseOBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: OBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: OBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE
        ...
        Private Sub ParseQUOTEDMODELELEMENTNAME(ByVal parent As ParseNode) ' NonTerminalSymbol: QUOTEDMODELELEMENTNAME
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: QUOTEDMODELELEMENTNAME
        ...
        Private Sub ParseVALUETYPEISWRITTENASCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: VALUETYPEISWRITTENASCLAUSE
            ...
            End If
                Case TokenType.KEYWDDATATYPEMONEY
                    ParseDATATYPEPRECISIONANDSCALE(node) ' NonTerminal Rule: DATATYPEPRECISIONANDSCALE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
        ...
        Private Sub ParseADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT

        Private Sub ParseADDOBJECTTYPETOPAGESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: ADDOBJECTTYPETOPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: ADDOBJECTTYPETOPAGESTMT

        Private Sub ParseCREATEPAGESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: CREATEPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: CREATEPAGESTMT
        ...
        Private Sub ParseCREATESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: CREATESTMT
            ...
            End If
             ...
             ' Concat Rule
            ParseCREATEPAGESTMT(node) ' NonTerminal Rule: CREATEPAGESTMT
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
        ...
        Private Sub ParseFACTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: FACTSTMT
            ...
            parent.Nodes.Add(node)
             ...
             ' Concat Rule
            ParseIDENTIFIERMODELELEMENT(node) ' NonTerminal Rule: IDENTIFIERMODELELEMENT
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
        ...
        Private Sub ParseLONGDESCRIPTIONSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: LONGDESCRIPTIONSTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: LONGDESCRIPTIONSTMT
        ...
        Private Sub ParseMODELELEMENTLEADINGSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: MODELELEMENTLEADINGSTMT
            ...
            End If
                Case TokenType.KEYWDISOBJECTIFIED
                    ParseISOBJECTIFIEDCLAUSE(node) ' NonTerminal Rule: ISOBJECTIFIEDCLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
                Case TokenType.KEYWDISWHERE
                    ParseISWHERECLAUSE(node) ' NonTerminal Rule: ISWHERECLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
                Case TokenType.KEYWDISIDENTIFIEDBY
                    ParseOBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE(node) ' NonTerminal Rule: OBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
            ...
            End If
                Case TokenType.COMMA
                    ParseFACTCLAUSE(node) ' NonTerminal Rule: FACTCLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
        ...
        Private Sub ParseBASEPRODUCTION(ByVal parent As ParseNode) ' NonTerminalSymbol: BASEPRODUCTION
            ...
            End If
                    Case TokenType.MODELELEMENTNAME
                        ParseLONGDESCRIPTIONSTMT(node) ' NonTerminal Rule: LONGDESCRIPTIONSTMT
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
            ...
            End If
                    Case TokenType.KEYWDADDOBJECTTYPESRELATEDTO
                        ParseADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT(node) ' NonTerminal Rule: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
                    Case TokenType.KEYWDADDOBJECTTYPE
                        ParseADDOBJECTTYPETOPAGESTMT(node) ' NonTerminal Rule: ADDOBJECTTYPETOPAGESTMT
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
        ...
        Private Sub ParseFEKLDOCUMENT(ByVal parent As ParseNode) ' NonTerminalSymbol: FEKLDOCUMENT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: FEKLDOCUMENT
        ...
        Private Sub ParseStart(ByVal parent As ParseNode) ' NonTerminalSymbol: Start
            ...
            parent.Nodes.Add(node)
             ...
             ' Concat Rule
            ParseFEKLDOCUMENT(node) ' NonTerminal Rule: FEKLDOCUMENT
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
