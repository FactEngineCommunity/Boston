    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Function ParseDATATYPELENGTH(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: DATATYPELENGTH
            ...
            Try
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDDATATYPERAWDATAFIXEDLENGTH, TokenType.KEYWDDATATYPERAWDATALARGELENGTH, TokenType.KEYWDDATATYPERAWDATAVARIABLELENGTH, TokenType.KEYWDDATATYPESTRINGFIXEDLENGTH, TokenType.KEYWDDATATYPETEXTFIXEDLENGTH, TokenType.KEYWDDATATYPESTRINGLARGELENGTH, TokenType.KEYWDDATATYPETEXTLARGELENGTH, TokenType.KEYWDDATATYPESTRINGVARIABLELENGTH, TokenType.KEYWDDATATYPETEXTVARIABLELENGTH}) ' Choice Rule
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPERAWDATAFIXEDLENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTFIXEDLENGTH"))
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPERAWDATAFIXEDLENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTLARGELENGTH"))
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPERAWDATAFIXEDLENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTVARIABLELENGTH"))
                    Select Case tok.Type
                     ' Choice Rule
                        ...
                        Case TokenType.KEYWDDATATYPETEXTFIXEDLENGTH
                                                lbProblemSolved = True
                                                        tok = m_scanner.Scan(TokenType.KEYWDDATATYPETEXTFIXEDLENGTH) ' Terminal Rule: KEYWDDATATYPETEXTFIXEDLENGTH
                            n = node.CreateNode(tok, tok.ToString() )
                            node.Token.UpdateRange(tok)
                            node.Nodes.Add(n)
                            If m_scanner.StartPos >= Me.MaxDistance Then
                              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTFIXEDLENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTFIXEDLENGTH"))
                            End If
                            If tok.Type <> TokenType.KEYWDDATATYPETEXTFIXEDLENGTH Then
                              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTFIXEDLENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTFIXEDLENGTH"))
                              lbProblemSolved = False
                              If liMaxRange >= Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                        ...
                        Case TokenType.KEYWDDATATYPETEXTLARGELENGTH
                                                lbProblemSolved = True
                                                        tok = m_scanner.Scan(TokenType.KEYWDDATATYPETEXTLARGELENGTH) ' Terminal Rule: KEYWDDATATYPETEXTLARGELENGTH
                            n = node.CreateNode(tok, tok.ToString() )
                            node.Token.UpdateRange(tok)
                            node.Nodes.Add(n)
                            If m_scanner.StartPos >= Me.MaxDistance Then
                              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTLARGELENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTLARGELENGTH"))
                            End If
                            If tok.Type <> TokenType.KEYWDDATATYPETEXTLARGELENGTH Then
                              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTLARGELENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTLARGELENGTH"))
                              lbProblemSolved = False
                              If liMaxRange >= Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                        ...
                        Case TokenType.KEYWDDATATYPETEXTVARIABLELENGTH
                                                lbProblemSolved = True
                                                        tok = m_scanner.Scan(TokenType.KEYWDDATATYPETEXTVARIABLELENGTH) ' Terminal Rule: KEYWDDATATYPETEXTVARIABLELENGTH
                            n = node.CreateNode(tok, tok.ToString() )
                            node.Token.UpdateRange(tok)
                            node.Nodes.Add(n)
                            If m_scanner.StartPos >= Me.MaxDistance Then
                              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTVARIABLELENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTVARIABLELENGTH"))
                            End If
                            If tok.Type <> TokenType.KEYWDDATATYPETEXTVARIABLELENGTH Then
                              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPETEXTVARIABLELENGTH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTVARIABLELENGTH"))
                              lbProblemSolved = False
                              If liMaxRange >= Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
        ...
        Private Function ParseENTITYTYPEISIDENTIFIEDBYITSCLAUSE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: ENTITYTYPEISIDENTIFIEDBYITSCLAUSE
            ...
            Try
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDISIDENTIFIEDBY) ' Terminal Rule: KEYWDISIDENTIFIEDBY
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                      m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISIDENTIFIEDBY.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISIDENTIFIEDBY"))
                    End If
                    If tok.Type <> TokenType.KEYWDISIDENTIFIEDBY Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISIDENTIFIEDBY.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISIDENTIFIEDBY"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDITS, TokenType.KEYWDTHEIR}) ' Choice Rule
                    
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDITS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDITS"))
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDITS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDTHEIR"))
                    Select Case tok.Type
                     ' Choice Rule
                        Case TokenType.KEYWDITS
                                                lbProblemSolved = True
                                                        tok = m_scanner.Scan(TokenType.KEYWDITS) ' Terminal Rule: KEYWDITS
                            n = node.CreateNode(tok, tok.ToString() )
                            node.Token.UpdateRange(tok)
                            node.Nodes.Add(n)
                            If m_scanner.StartPos >= Me.MaxDistance Then
                              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDITS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDITS"))
                            End If
                            If tok.Type <> TokenType.KEYWDITS Then
                              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDITS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDITS"))
                              lbProblemSolved = False
                              If liMaxRange >= Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                        ...
                        Case TokenType.KEYWDTHEIR
                                                lbProblemSolved = True
                                                        tok = m_scanner.Scan(TokenType.KEYWDTHEIR) ' Terminal Rule: KEYWDTHEIR
                            n = node.CreateNode(tok, tok.ToString() )
                            node.Token.UpdateRange(tok)
                            node.Nodes.Add(n)
                            If m_scanner.StartPos >= Me.MaxDistance Then
                              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDTHEIR.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDTHEIR"))
                            End If
                            If tok.Type <> TokenType.KEYWDTHEIR Then
                              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDTHEIR.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDTHEIR"))
                              lbProblemSolved = False
                              If liMaxRange >= Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
...
lbProblemSolved =                         ParseVALUETYPEWRITTENASCLAUSE(node) ' NonTerminal Rule: VALUETYPEWRITTENASCLAUSE
        ...
        Private Function ParseENTITYTYPEIDENTIFIEDBYITSCLAUSE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: ENTITYTYPEIDENTIFIEDBYITSCLAUSE
            ...
            Try
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDIDENTIFIEDBY) ' Terminal Rule: KEYWDIDENTIFIEDBY
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                      m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDIDENTIFIEDBY.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDIDENTIFIEDBY"))
                    End If
                    If tok.Type <> TokenType.KEYWDIDENTIFIEDBY Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDIDENTIFIEDBY.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDIDENTIFIEDBY"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
        ...
        Private Function ParseFACTTYPECLAUSE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: FACTTYPECLAUSE
            ...
            lbProblemSolved =                     ParsePREDICATECLAUSE(node) ' NonTerminal Rule: PREDICATECLAUSE
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDANYNUMBEROF, TokenType.KEYWDATLEASTONE, TokenType.KEYWDATMOSTONE, TokenType.KEYWDONE, TokenType.PREBOUNDREADINGTEXT, TokenType.SINGLEQUOTE, TokenType.MODELELEMENTNAME}) ' Choice Rule
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDANYNUMBEROF.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "SINGLEQUOTE"))
...
lbProblemSolved =                         ParseVALUETYPEWRITTENASCLAUSE(node) ' NonTerminal Rule: VALUETYPEWRITTENASCLAUSE
        ...
        Private Function ParseISOBJECTIFIEDCLAUSE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: ISOBJECTIFIEDCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.ISOBJECTIFIEDCLAUSE), "ISOBJECTIFIEDCLAUSE")
            Dim lbProblemSolved As Boolean = True
            ...
            Try
            lbProblemSolved = True
                        tok = m_scanner.Scan(TokenType.KEYWDISOBJECTIFIED) ' Terminal Rule: KEYWDISOBJECTIFIED
            n = node.CreateNode(tok, tok.ToString() )
            node.Token.UpdateRange(tok)
            node.Nodes.Add(n)
            If m_scanner.StartPos >= Me.MaxDistance Then
              m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISOBJECTIFIED.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISOBJECTIFIED"))
            End If
            If tok.Type <> TokenType.KEYWDISOBJECTIFIED Then
              m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISOBJECTIFIED.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISOBJECTIFIED"))
              lbProblemSolved = False
              If liMaxRange >= Me.MaxDistance Then
                Me.MaxDistance = m_scanner.StartPos
            ...
            End Try
            Return lbProblemSolved
        End Function ' NonTerminalSymbol: ISOBJECTIFIEDCLAUSE
        ...
        Private Function ParseMODELELEMENT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: MODELELEMENT
            ...
            Try
             ...
             ' Concat Rule
            lbProblemSolved =                     ParseQUOTEDMODELELEMENTNAME(node) ' NonTerminal Rule: QUOTEDMODELELEMENTNAME
                    If m_tree.Errors.Count > 0 Then
                      If m_scanner.EndPos > Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
                        max_tree = m_tree.clone
        ...
        Private Function ParseMODELELEMENTTYPE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: MODELELEMENTTYPE
            ...
            Try
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDANYNUMBEROF, TokenType.KEYWDATLEASTONE, TokenType.KEYWDONE, TokenType.KEYWDATMOSTONE, TokenType.PREBOUNDREADINGTEXT, TokenType.SINGLEQUOTE, TokenType.MODELELEMENTNAME}) ' Choice Rule
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDWRITTENAS, TokenType.KEYWDIDENTIFIEDBY}) ' Option Rule
                    If m_scanner.EndPos >= Me.MaxDistance Then
                                            max_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDWRITTENAS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDWRITTENAS"))
                                            max_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDIDENTIFIEDBY.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDIDENTIFIEDBY"))
                    End If
                    If tok.Type = TokenType.KEYWDWRITTENAS Or tok.Type = TokenType.KEYWDIDENTIFIEDBY Then
                        tok = m_scanner.LookAhead({TokenType.KEYWDWRITTENAS, TokenType.KEYWDIDENTIFIEDBY}) ' Choice Rule
                        
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDWRITTENAS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDWRITTENAS"))
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDWRITTENAS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDIDENTIFIEDBY"))
                        Select Case tok.Type
                         ' Choice Rule
        ...
        Private Function ParseQUOTEDMODELELEMENTNAME(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: QUOTEDMODELELEMENTNAME
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.QUOTEDMODELELEMENTNAME), "QUOTEDMODELELEMENTNAME")
            Dim lbProblemSolved As Boolean = True
        ...
        Private Function ParseVALUETYPEISWRITTENASCLAUSE(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: VALUETYPEISWRITTENASCLAUSE
            ...
            Try
             ...
             ' Concat Rule
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPELOGICALTRUEFALSE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTFIXEDLENGTH"))
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPELOGICALTRUEFALSE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTLARGELENGTH"))
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDDATATYPELOGICALTRUEFALSE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDDATATYPETEXTVARIABLELENGTH"))
        ...
        Private Function ParseADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT), "ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT")
            Dim lbProblemSolved As Boolean = True
            ...
            Try
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDADDOBJECTTYPESRELATEDTO) ' Terminal Rule: KEYWDADDOBJECTTYPESRELATEDTO
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                    ...
                    End If
                    If tok.Type <> TokenType.KEYWDADDOBJECTTYPESRELATEDTO Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDADDOBJECTTYPESRELATEDTO.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDADDOBJECTTYPESRELATEDTO"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
            ...
            lbProblemSolved =                     ParseQUOTEDMODELELEMENTNAME(node) ' NonTerminal Rule: QUOTEDMODELELEMENTNAME
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDTOPAGE) ' Terminal Rule: KEYWDTOPAGE
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                      m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDTOPAGE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDTOPAGE"))
                    End If
                    If tok.Type <> TokenType.KEYWDTOPAGE Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDTOPAGE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDTOPAGE"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
             ...
             ' Concat Rule
                    ...
                    If tok.Type = TokenType.COMMA Then
                         ...
                         ' Concat Rule
                                                        lbProblemSolved = True
                                                                tok = m_scanner.Scan(TokenType.KEYWDANYFACTTYPE) ' Terminal Rule: KEYWDANYFACTTYPE
                                n = node.CreateNode(tok, tok.ToString() )
                                node.Token.UpdateRange(tok)
                                node.Nodes.Add(n)
                                If m_scanner.StartPos >= Me.MaxDistance Then
                                  m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDANYFACTTYPE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDANYFACTTYPE"))
                                End If
                                If tok.Type <> TokenType.KEYWDANYFACTTYPE Then
                                  m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDANYFACTTYPE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDANYFACTTYPE"))
                                  lbProblemSolved = False
                                  If liMaxRange >= Me.MaxDistance Then
                                    Me.MaxDistance = m_scanner.StartPos
            ...
            End Try
            Return lbProblemSolved
        End Function ' NonTerminalSymbol: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT

        Private Function ParseADDOBJECTTYPETOPAGESTMT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: ADDOBJECTTYPETOPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.ADDOBJECTTYPETOPAGESTMT), "ADDOBJECTTYPETOPAGESTMT")
            Dim lbProblemSolved As Boolean = True
            ...
            Try
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDADDOBJECTTYPE) ' Terminal Rule: KEYWDADDOBJECTTYPE
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                    ...
                    End If
                    If tok.Type <> TokenType.KEYWDADDOBJECTTYPE Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDADDOBJECTTYPE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDADDOBJECTTYPE"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
            ...
            lbProblemSolved =                     ParseQUOTEDMODELELEMENTNAME(node) ' NonTerminal Rule: QUOTEDMODELELEMENTNAME
             ...
             ' Concat Rule
                    ...
                    If tok.Type = TokenType.COMMA Then
                         ...
                         ' Concat Rule
                                                        lbProblemSolved = True
                                                                tok = m_scanner.Scan(TokenType.KEYWDSTANDALONE) ' Terminal Rule: KEYWDSTANDALONE
                                n = node.CreateNode(tok, tok.ToString() )
                                node.Token.UpdateRange(tok)
                                node.Nodes.Add(n)
                                If m_scanner.StartPos >= Me.MaxDistance Then
                                  m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDSTANDALONE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDSTANDALONE"))
                                End If
                                If tok.Type <> TokenType.KEYWDSTANDALONE Then
                                  m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDSTANDALONE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDSTANDALONE"))
                                  lbProblemSolved = False
                                  If liMaxRange >= Me.MaxDistance Then
                                    Me.MaxDistance = m_scanner.StartPos
        ...
        Private Function ParseCREATEPAGESTMT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: CREATEPAGESTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.CREATEPAGESTMT), "CREATEPAGESTMT")
            Dim lbProblemSolved As Boolean = True
            ...
            End Try
            Return lbProblemSolved
        End Function ' NonTerminalSymbol: CREATEPAGESTMT
        ...
        Private Function ParseLONGDESCRIPTIONSTMT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: LONGDESCRIPTIONSTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.LONGDESCRIPTIONSTMT), "LONGDESCRIPTIONSTMT")
            Dim lbProblemSolved As Boolean = True
            ...
            Try
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.KEYWDHASLONGDESCRIPTION) ' Terminal Rule: KEYWDHASLONGDESCRIPTION
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                      m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDHASLONGDESCRIPTION.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDHASLONGDESCRIPTION"))
                    End If
                    If tok.Type <> TokenType.KEYWDHASLONGDESCRIPTION Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDHASLONGDESCRIPTION.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDHASLONGDESCRIPTION"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
             ...
             ' Concat Rule
                                lbProblemSolved = True
                                        tok = m_scanner.Scan(TokenType.DESCRIPTIONCONTENT) ' Terminal Rule: DESCRIPTIONCONTENT
                    n = node.CreateNode(tok, tok.ToString() )
                    node.Token.UpdateRange(tok)
                    node.Nodes.Add(n)
                    If m_scanner.StartPos >= Me.MaxDistance Then
                      m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.DESCRIPTIONCONTENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "DESCRIPTIONCONTENT"))
                    End If
                    If tok.Type <> TokenType.DESCRIPTIONCONTENT Then
                      m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.DESCRIPTIONCONTENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "DESCRIPTIONCONTENT"))
                      lbProblemSolved = False
                      If liMaxRange >= Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
            ...
            End Try
            Return lbProblemSolved
        End Function ' NonTerminalSymbol: LONGDESCRIPTIONSTMT
...
lbProblemSolved =                         ParseFRONTREADINGTEXTCLAUSE(node) ' NonTerminal Rule: FRONTREADINGTEXTCLAUSE
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.PREBOUNDREADINGTEXT, TokenType.SINGLEQUOTE, TokenType.MODELELEMENTNAME}) ' Choice Rule
                    ...
                    End Select ' Choice Rule
                        ...
                        If Not lbProblemSolved Then
                          ...
                          If liMaxRange > Me.MaxDistance Then
                            ...
                            max_tree = m_tree.clone
                          End If
                    lbProblemSolved =                         ParseQUOTEDMODELELEMENTNAME(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: QUOTEDMODELELEMENTNAME
                        If m_tree.Errors.Count > 0 Then
                          If m_scanner.EndPos > Me.MaxDistance Then
                            Me.MaxDistance = m_scanner.StartPos
                            max_tree = m_tree.clone
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.KEYWDISAKINDOF, TokenType.KEYWDISACONCEPT, TokenType.KEYWDISANENTITYTYPE, TokenType.KEYWDISAVALUETYPE, TokenType.KEYWDISOBJECTIFIED, TokenType.KEYWDISWHERE, TokenType.KEYWDISIDENTIFIEDBY, TokenType.KEYWDISWRITTENAS, TokenType.COMMA, TokenType.KEYWDINCLUDES, TokenType.PREDICATEPART, TokenType.UNARYPREDICATEPART}) ' Choice Rule
                        ...
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISAKINDOF.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISOBJECTIFIED"))
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISAKINDOF.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISWHERE"))
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISAKINDOF.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISIDENTIFIEDBY"))
                        m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISAKINDOF.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISIDENTIFIEDBY"))
                    ...
                    lbProblemSolved =                             ParseISOBJECTIFIEDCLAUSE(node) ' NonTerminal Rule: ISOBJECTIFIEDCLAUSE
                            If m_tree.Errors.Count > 0 Then
                              If m_scanner.EndPos > Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                                max_tree = m_tree.clone
                    ...
                    lbProblemSolved =                         ParseISAVALUETYPECLAUSE(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: ISAVALUETYPECLAUSE
                        ...
                        If Not lbProblemSolved Then
                          ...
                          If liMaxRange > Me.MaxDistance Then
                            ...
                            max_tree = m_tree.clone
                          End If
                    lbProblemSolved =                         ParseISOBJECTIFIEDCLAUSE(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: ISOBJECTIFIEDCLAUSE
                        If m_tree.Errors.Count > 0 Then
                          If m_scanner.EndPos > Me.MaxDistance Then
                            Me.MaxDistance = m_scanner.StartPos
                            max_tree = m_tree.clone
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead({TokenType.NEWLINE}) ' Option Rule
                    If m_scanner.EndPos >= Me.MaxDistance Then
                                            max_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.NEWLINE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "NEWLINE"))
                    End If
                    If tok.Type = TokenType.NEWLINE Then
                        lbProblemSolved = True
                                                tok = m_scanner.Scan(TokenType.NEWLINE) ' Terminal Rule: NEWLINE
                        n = node.CreateNode(tok, tok.ToString() )
                        node.Token.UpdateRange(tok)
                        node.Nodes.Add(n)
                        If m_scanner.StartPos >= Me.MaxDistance Then
...
lbProblemSolved =                         ParseNATURALLANGUAGEPROMPT(node) ' NonTerminal Rule: NATURALLANGUAGEPROMPT
                        ...
                        End Select ' Choice Rule
                            ...
                            If Not lbProblemSolved Then
                              ...
                              If liMaxRange > Me.MaxDistance Then
                                ...
                                max_tree = m_tree.clone
                              End If
                        lbProblemSolved =                             ParseLONGDESCRIPTIONSTMT(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: LONGDESCRIPTIONSTMT
                            If m_tree.Errors.Count > 0 Then
                              If m_scanner.EndPos > Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                                max_tree = m_tree.clone
                        ...
                        lbProblemSolved =                             ParseMODELELEMENTLEADINGSTMT(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: MODELELEMENTLEADINGSTMT
                            ...
                            If Not lbProblemSolved Then
                              ...
                              If liMaxRange > Me.MaxDistance Then
                                ...
                                max_tree = m_tree.clone
                              End If
                        lbProblemSolved =                             ParseCREATEPAGESTMT(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: CREATEPAGESTMT
                            If m_tree.Errors.Count > 0 Then
                              If m_scanner.EndPos > Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                                max_tree = m_tree.clone
                            ...
                            If Not lbProblemSolved Then
                              ...
                              If liMaxRange > Me.MaxDistance Then
                                ...
                                max_tree = m_tree.clone
                              End If
                        lbProblemSolved =                             ParseADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: ADDOBJECTTYPESRELATEDTOMODELELEMENTTOPAGESTMT
                            If m_tree.Errors.Count > 0 Then
                              If m_scanner.EndPos > Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                                max_tree = m_tree.clone
                            ...
                            If Not lbProblemSolved Then
                              ...
                              If liMaxRange > Me.MaxDistance Then
                                ...
                                max_tree = m_tree.clone
                              End If
                        lbProblemSolved =                             ParseADDOBJECTTYPETOPAGESTMT(parent.Nodes(parent.Nodes.Count -1)) ' NonTerminal Rule: ADDOBJECTTYPETOPAGESTMT
                            If m_tree.Errors.Count > 0 Then
                              If m_scanner.EndPos > Me.MaxDistance Then
                                Me.MaxDistance = m_scanner.StartPos
                                max_tree = m_tree.clone
        ...
        Private Function ParseFEKLDOCUMENT(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: FEKLDOCUMENT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.FEKLDOCUMENT), "FEKLDOCUMENT")
            Dim lbProblemSolved As Boolean = True
            ...
            Try
             ...
             ' Concat Rule
                                tok = m_scanner.LookAhead(TokenType.COMMENT, TokenType.FRONTREADINGTEXT, TokenType.PREBOUNDREADINGTEXT, TokenType.SINGLEQUOTE, TokenType.MODELELEMENTNAME) ' ZeroOrMore Rule
                    While tok.Type = TokenType.COMMENT Or tok.Type = TokenType.FRONTREADINGTEXT Or tok.Type = TokenType.PREBOUNDREADINGTEXT Or tok.Type = TokenType.SINGLEQUOTE Or tok.Type = TokenType.MODELELEMENTNAME
                    m_tree.Errors.Clear
                        tok = m_scanner.LookAhead({TokenType.COMMENT, TokenType.FRONTREADINGTEXT, TokenType.PREBOUNDREADINGTEXT, TokenType.SINGLEQUOTE, TokenType.MODELELEMENTNAME}) ' Choice Rule
                        
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.COMMENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "COMMENT"))
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.COMMENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "FRONTREADINGTEXT"))
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.COMMENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREBOUNDREADINGTEXT"))
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.COMMENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "SINGLEQUOTE"))
                            m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.COMMENT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "MODELELEMENTNAME"))
                        Select Case tok.Type
                         ' Choice Rule
                            Case TokenType.COMMENT
                                                        lbProblemSolved = True
                                                                tok = m_scanner.Scan(TokenType.COMMENT) ' Terminal Rule: COMMENT
                                n = node.CreateNode(tok, tok.ToString() )
                                node.Token.UpdateRange(tok)
                                node.Nodes.Add(n)
                                If m_scanner.StartPos >= Me.MaxDistance Then
            ...
            End Try
            Return lbProblemSolved
        End Function ' NonTerminalSymbol: FEKLDOCUMENT
        ...
        Private Function ParseStart(ByVal parent As ParseNode) As Boolean ' NonTerminalSymbol: Start
            ...
            Try
             ...
             ' Concat Rule
            lbProblemSolved =                     ParseFEKLDOCUMENT(node) ' NonTerminal Rule: FEKLDOCUMENT
                    If m_tree.Errors.Count > 0 Then
                      If m_scanner.EndPos > Me.MaxDistance Then
                        Me.MaxDistance = m_scanner.StartPos
                        max_tree = m_tree.clone
