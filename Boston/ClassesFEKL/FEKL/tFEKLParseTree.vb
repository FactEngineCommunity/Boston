...
#Region "ParseNode"
    ...
    Partial Public Class ParseNode 
        ...
        Friend Function Eval(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            ...
            Select Case Token.Type
                ...
                Case TokenType.BASEPRODUCTION
                    ...
                    Exit Select
                Case TokenType.FEKLDOCUMENT
                    Value = EvalFEKLDOCUMENT(tree, paramlist)
                    Exit Select
        ...
        Protected Overridable Function EvalFEKLDOCUMENT(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
