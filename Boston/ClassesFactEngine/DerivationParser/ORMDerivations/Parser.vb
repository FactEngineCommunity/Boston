...
#Region "Parser"
    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseNODEPROPERTYNAMEIDENTIFICATION(ByVal parent As ParseNode) ' NonTerminalSymbol: NODEPROPERTYNAMEIDENTIFICATION
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: NODEPROPERTYNAMEIDENTIFICATION
        ...
        Private Sub ParseNUMBER1(ByVal parent As ParseNode) ' NonTerminalSymbol: NUMBER1
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: NUMBER1

        Private Sub ParseNUMBER2(ByVal parent As ParseNode) ' NonTerminalSymbol: NUMBER2
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: NUMBER2
        ...
        Private Sub ParsePROPERTYIDENTIFIER(ByVal parent As ParseNode) ' NonTerminalSymbol: PROPERTYIDENTIFIER
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: PROPERTYIDENTIFIER
        ...
        Private Sub ParseQUOTEDPROPERTYIDENTIFIERLIST(ByVal parent As ParseNode) ' NonTerminalSymbol: QUOTEDPROPERTYIDENTIFIERLIST
            Dim tok As Token
            Dim n As ParseNode
            ...
            End If
             ...
             ' Concat Rule
            ParsePROPERTYIDENTIFIER(node) ' NonTerminal Rule: PROPERTYIDENTIFIER
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: QUOTEDPROPERTYIDENTIFIERLIST

        Private Sub ParseRECURSIVECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: RECURSIVECLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            End If
                Case TokenType.NUMBER
                    ...
                    If tok.Type = TokenType.NUMBER Then
                        ParseNUMBER1(node) ' NonTerminal Rule: NUMBER1
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
            ...
            End If
                    ...
                    tok = m_scanner.LookAhead(TokenType.NUMBER) ' Option Rule
                    If tok.Type = TokenType.NUMBER Then
                        ParseNUMBER2(node) ' NonTerminal Rule: NUMBER2
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: RECURSIVECLAUSE
        ...
        Private Sub ParseRETURNCOLUMN(ByVal parent As ParseNode) ' NonTerminalSymbol: RETURNCOLUMN
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.RETURNCOLUMN), "RETURNCOLUMN")
            parent.Nodes.Add(node)

            tok = m_scanner.LookAhead(TokenType.STAR, TokenType.MODELELEMENTNAME) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.STAR
                    tok = m_scanner.Scan(TokenType.STAR) ' Terminal Rule: STAR
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: RETURNCOLUMN
        ...
        Private Sub ParseASSIGNMENTCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: ASSIGNMENTCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.ASSIGNMENTCLAUSE), "ASSIGNMENTCLAUSE")
            parent.Nodes.Add(node)
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: ASSIGNMENTCLAUSE
        ...
        Private Sub ParseCONNECTTOMODELSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: CONNECTTOMODELSTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: CONNECTTOMODELSTMT
        ...
        Private Sub ParseCREATEDATABASESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: CREATEDATABASESTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            End If
                 ...
                 ' Concat Rule
                ParseDATABASECREATECLAUSE(node) ' NonTerminal Rule: DATABASECREATECLAUSE
            If m_tree.Errors.Count > 0 Then
                            parent.Token.UpdateRange(node.Token)
                            Exit Sub
            End If
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: CREATEDATABASESTMT
            ...
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.KEYWDDATABASE
                    ParseCREATEDATABASESTMT(node) ' NonTerminal Rule: CREATEDATABASESTMT
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
        ...
        Private Sub ParseDATABASECREATECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: DATABASECREATECLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.KEYWDLOCATION
                    ParseDATABASELOCATIONCLAUSE(node) ' NonTerminal Rule: DATABASELOCATIONCLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
                Case TokenType.KEYWDTYPE
                    ParseDATABASETYPECLAUSE(node) ' NonTerminal Rule: DATABASETYPECLAUSE
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: DATABASECREATECLAUSE

        Private Sub ParseDATABASELOCATIONCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: DATABASELOCATIONCLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: DATABASELOCATIONCLAUSE

        Private Sub ParseDATABASETYPECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: DATABASETYPECLAUSE
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: DATABASETYPECLAUSE
        ...
        Private Sub ParseDERIVATIONSUBCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: DERIVATIONSUBCLAUSE
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.EQUALS) ' Option Rule
            If tok.Type = TokenType.EQUALS Then
                tok = m_scanner.Scan(TokenType.EQUALS) ' Terminal Rule: EQUALS
                n = node.CreateNode(tok, tok.ToString() )
                node.Token.UpdateRange(tok)
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.MODELELEMENTNAME, TokenType.EXPRESSIONSYMBOL, TokenType.PREDICATE) ' ZeroOrMore Rule
            While tok.Type = TokenType.PREBOUNDREADINGTEXT Or tok.Type = TokenType.MODELELEMENTNAME Or tok.Type = TokenType.EXPRESSIONSYMBOL Or tok.Type = TokenType.PREDICATE
                tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.MODELELEMENTNAME, TokenType.EXPRESSIONSYMBOL, TokenType.PREDICATE) ' Choice Rule
                Select Case tok.Type
                 ' Choice Rule
            ...
            End If
                    Case TokenType.EXPRESSIONSYMBOL
                        ParseEXPRESSIONPART(node) ' NonTerminal Rule: EXPRESSIONPART
            If m_tree.Errors.Count > 0 Then
                                    parent.Token.UpdateRange(node.Token)
                                    Exit Sub
            End If
            ...
            End If
                    ...
                    m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "EXPRESSIONSYMBOL"))
                    m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREDICATE"))
                    End If
                        m_tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found.", &H0002, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos))
                        Exit Select
                End Select ' Choice Rule
        ...
        Private Sub ParseEXPRESSIONPART(ByVal parent As ParseNode) ' NonTerminalSymbol: EXPRESSIONPART
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: EXPRESSIONPART
        ...
        Private Sub ParseFACTTYPEPRODUCTION(ByVal parent As ParseNode) ' NonTerminalSymbol: FACTTYPEPRODUCTION
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDISWHERE, TokenType.PREDICATE) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
            ...
            End If
                ...
                m_tree.Optionals.Clear
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISWHERE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISWHERE"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISWHERE.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREDICATE"))
                End If
                    m_tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found.", &H0002, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos))
                    Exit Select
            End Select ' Choice Rule
        ...
        Private Sub ParseWHICHTHATCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: WHICHTHATCLAUSE
            ...
            End If
                            ...
                            If tok.Type = TokenType.OPENSQUAREBRACKET Then
                                ParseRECURSIVECLAUSE(node) ' NonTerminal Rule: RECURSIVECLAUSE
            If m_tree.Errors.Count > 0 Then
                                            parent.Token.UpdateRange(node.Token)
                                            Exit Sub
            End If
        ...
        Private Sub ParseDERIVATIONSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: DERIVATIONSTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.DERIVATIONSTMT), "DERIVATIONSTMT")
            parent.Nodes.Add(node)
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: DERIVATIONSTMT
        ...
        Private Sub ParseStart(ByVal parent As ParseNode) ' NonTerminalSymbol: Start
            ...
            parent.Nodes.Add(node)
             ...
             ' Concat Rule
            ParseDERIVATIONSTMT(node) ' NonTerminal Rule: DERIVATIONSTMT
            If m_tree.Errors.Count > 0 Then
                        parent.Token.UpdateRange(node.Token)
                        Exit Sub
            End If
