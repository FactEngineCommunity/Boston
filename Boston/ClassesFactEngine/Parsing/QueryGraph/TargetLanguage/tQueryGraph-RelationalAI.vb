Namespace FactEngine
    Partial Public Class QueryGraph
        ...
        'https://docs.relational.ai/rel/concepts/relational-knowledge-graphs/elements-rkg#building-And-querying-a-graph
        'https://docs.relational.ai/rkgms/console/queries
        'https://docs.relational.ai/rkgms/console/queries#using-the-query-editor
        'https://docs.relational.ai/rkgms/console/queries#running-queries

        Public Function generateRelationalAIQL(ByRef arWhichSelectStatement As FEQL.WHICHSELECTStatement,
