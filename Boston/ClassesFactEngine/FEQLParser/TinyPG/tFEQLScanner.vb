...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        KEYWDADD    = 133
        KEYWDADDFACT= 134
        KEYWDADDFACTTYPE= 135
        KEYWDASSERT = 136
        KEYWDATMOSTONE= 137
        KEYWDBUTNOTBOTH= 138
        KEYWDCOMBINATION= 139
        KEYWDCOUNTSTAR= 140
        KEYWDCREATE = 141
        KEYWDCREATECONCEPT= 142
        KEYWDCREATEENTITYTYPE= 143
        KEYWDCREATEFACTTYPE= 144
        KEYWDCREATEMODEL= 145
        KEYWDCREATEVALUETYPE= 146
        KEYWDDATATYPELOGICALTRUEFALSE= 147
        KEYWDDATATYPELOGICALYESNO= 148
        KEYWDDATATYPEAUTOCOUNTER= 149
        KEYWDDATATYPEDECIMAL= 150
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 151
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 152
        KEYWDDATATYPEFLOATSINGLEPRECISION= 153
        KEYWDDATATYPEMONEY= 154
        KEYWDDATATYPESIGNEDBIGINTEGER= 155
        KEYWDDATATYPESIGNEDINTEGER= 156
        KEYWDDATATYPESIGNEDSMALLINTEGER= 157
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 158
        KEYWDDATATYPEUNSIGNEDINTEGER= 159
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 160
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 161
        KEYWDDATATYPEOBJECTID= 162
        KEYWDDATATYPEROWID= 163
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 164
        KEYWDDATATYPERAWDATALARGELENGTH= 165
        KEYWDDATATYPERAWDATAOLEOBJECT= 166
        KEYWDDATATYPERAWDATA= 167
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 168
        KEYWDDATATYPEAUTOTIMESTAMP= 169
        KEYWDDATATYPEDATE= 170
        KEYWDDATATYPEDATETIME= 171
        KEYWDDATATYPETIME= 172
        KEYWDDATATYPESTRINGFIXEDLENGTH= 173
        KEYWDDATATYPESTRINGLARGELENGTH= 174
        KEYWDDATATYPESTRINGVARIABLELENGTH= 175
        KEYWDDELETE = 176
        KEYWDDELETEALL= 177
        KEYWDDELETEFACT= 178
        KEYWDDESCRIBE= 179
