...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        FACTREADING = 16
        FACTTYPENAMESTR= 17
        FACTTYPEPREDICATE= 18
        FACTTYPESIMPLEPREDICATE= 19
        INSERTCOLUMNLIST= 20
        MATCHPREDICATE= 21
        MATCHFACTTYPEPREDICATE= 22
        MODELELEMENT= 23
        MODELELEMENTPLURAL= 24
        MODELELEMENTSTR= 25
        MODELMODELELEMENT= 26
        NODESTMT    = 27
        NODEPROPERTYIDENTIFICATION= 28
        NODEIDENTIFICATION= 29
        PREDICATECLAUSE= 30
        REFERENCEMODECLAUSE= 31
        RETURNCLAUSE= 32
        RETURNFACTTYPEPREDICATE= 33
        RETURNPREDICATE= 34
        ROLENAMESTR = 35
        SETCLAUSE   = 36
        VALUELIST   = 37
        VALUESTRING = 38
        ADDENTITYTYPESTMT= 39
        ADDFACTSTMT = 40
        ADDFACTTYPESTMT= 41
        ADDROLESTMT = 42
        ADDMODELELEMENTSTMT= 43
        ADDVALUETYPESTMT= 44
        ASSERTSTMT  = 45
        BINARYFACTTYPEMANYTOONEDEFINITIONSTMT= 46
        CONSTRAINTEITHEROREXTERNAL= 47
        CONSTRAINTEITHERORSUBTYPE= 48
        CONSTRAINTEITHEROR= 49
        CONSTRAINTEXTERNALUNIQUENESS= 50
        CONSTRAINTINCLUSIVEOR= 51
        CONSTRAINTEXTERNALSTMT= 52
        CONSTRAINTMANDATORY= 53
        CREATECONCEPTSTMT= 54
        CREATEENTITYTYPESTMT= 55
        CREATEFACTTYPESTMT= 56
        CREATEMODELSTMT= 57
        CREATEMODELELEMENTSTMT= 58
        CREATESTMT  = 59
        CREATEVALUETYPESTMT= 60
        DELETESTMT  = 61
        DELETEFROMCLAUSE= 62
        DELETEALLSTMT= 63
        DELETEFACTSTMT= 64
        DERIVEDFACTTYPESTMT= 65
        ENUMERATESTMT= 66
        EXISTSSTMT  = 67
        EXTERNALUNIQUENESSCONSTRAINTSTMT= 68
        FACTTYPEISWHERESTMT= 69
        FACTTYPESTMT= 70
        FACTTYPEIDENTIFICATION= 71
        FACTTYPEPARTCLAUSE= 72
        BINARYFACTTYPECLAUSE= 73
        FACTTYPEPRODUCTION= 74
        FACTSTMT    = 75
        GETSUPERTYPESTMT= 76
        INMODELSTMT = 77
        INSERTSTMT  = 78
        ITISMANDATORYTHATSTMNT= 79
        LISTSTMT    = 80
        MATCHFACTTYPESTMT= 81
        MATCHSELECTSETFACTTYPESTMT= 82
        MATCHSELECTSTMT= 83
        ONPAGESTMT  = 84
        OPENMODELSTMT= 85
        SELECTSTMT  = 86
        SUBTYPESTMT = 87
        TABLEIDENTIFICATION= 88
        UPDATESTMT  = 89
        VALUETYPEISWRITTENASSTMT= 90
        WHERESTMT   = 91
        WHICHCLAUSE = 92
        WHICHSELECTSTMT= 93
        WITHPREDICATESTMT= 94
        Start       = 95
        ...
        COLUMNNAMESTR= 99
        COMMA       = 100
        CURLYBRACKETCLOSE= 101
        CURLYBRACKETOPEN= 102
        DOUBLEQUOTE = 103
        EOF         = 104
        EQUALS      = 105
        FACTTYPENAME= 106
        ...
        KEYWDADD    = 128
        KEYWDADDFACT= 129
        KEYWDADDFACTTYPE= 130
        KEYWDASSERT = 131
        KEYWDATMOSTONE= 132
        KEYWDBUTNOTBOTH= 133
        KEYWDCOMBINATION= 134
        KEYWDCOUNTSTAR= 135
        KEYWDCREATE = 136
        KEYWDCREATECONCEPT= 137
        KEYWDCREATEENTITYTYPE= 138
        KEYWDCREATEFACTTYPE= 139
        KEYWDCREATEMODEL= 140
        KEYWDCREATEVALUETYPE= 141
        KEYWDDATATYPELOGICALTRUEFALSE= 142
        KEYWDDATATYPELOGICALYESNO= 143
        KEYWDDATATYPEAUTOCOUNTER= 144
        KEYWDDATATYPEDECIMAL= 145
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 146
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 147
        KEYWDDATATYPEFLOATSINGLEPRECISION= 148
        KEYWDDATATYPEMONEY= 149
        KEYWDDATATYPESIGNEDBIGINTEGER= 150
        KEYWDDATATYPESIGNEDINTEGER= 151
        KEYWDDATATYPESIGNEDSMALLINTEGER= 152
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 153
        KEYWDDATATYPEUNSIGNEDINTEGER= 154
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 155
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 156
        KEYWDDATATYPEOBJECTID= 157
        KEYWDDATATYPEROWID= 158
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 159
        KEYWDDATATYPERAWDATALARGELENGTH= 160
        KEYWDDATATYPERAWDATAOLEOBJECT= 161
        KEYWDDATATYPERAWDATA= 162
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 163
        KEYWDDATATYPEAUTOTIMESTAMP= 164
        KEYWDDATATYPEDATE= 165
        KEYWDDATATYPEDATETIME= 166
        KEYWDDATATYPETIME= 167
        KEYWDDATATYPESTRINGFIXEDLENGTH= 168
        KEYWDDATATYPESTRINGLARGELENGTH= 169
        KEYWDDATATYPESTRINGVARIABLELENGTH= 170
        KEYWDDELETE = 171
        KEYWDDELETEALL= 172
        KEYWDDELETEFACT= 173
        KEYWDDISTINCT= 174
        ...
        KEYWDFROM   = 187
        KEYWDGET    = 188
        KEYWDIFANDONLYIF= 189
        KEYWDIN     = 190
        KEYWDINSERT = 191
        KEYWDINTO   = 192
        KEYWDISA    = 193
        KEYWDISIDENTIFIEDBYITS= 194
        KEYWDISWHERE= 195
        KEYWDISWRITTENAS= 196
        KEYWDITISMANDATORYTHAT= 197
        KEYWDJOINING= 198
        KEYWDINDEX  = 199
        KEYWDLANGUAGE= 200
        KEYWDLANGUAGEDFD= 201
        KEYWDLANGUAGEERD= 202
        KEYWDLANGUAGEETD= 203
        KEYWDLANGUAGEORM= 204
        KEYWDLANGUAGESTD= 205
        KEYWDLANGUAGEUCD= 206
        KEYWDLIST   = 207
        KEYWDMATCH  = 208
        KEYWDMODEL  = 209
        KEYWDMODELNOTES= 210
        KEYWDMODELDICTIONARY= 211
        KEYWDNULL   = 212
        KEYWDOBJECT = 213
        KEYWDOCCURSATLEASTONETIME= 214
        KEYWDOCCURSATLEASTONETIMEINEACHOF= 215
        KEYWDOF     = 216
        KEYWDON     = 217
        KEYWDONE    = 218
        KEYWDONPAGE = 219
        ...
        KEYWDROLE   = 225
        KEYWDSELECT = 226
        KEYWDRESTRICTEDTO= 227
        KEYWDROLECONSTRAINTS= 228
        KEYWDSET    = 229
        KEYWDSUPERTYPE= 230
        KEYWDTHAT   = 231
        KEYWDTO     = 232
