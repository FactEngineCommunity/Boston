...
#End Region
    ...
    Private Sub HighlightToken(ByVal token As Token, ByVal sb As StringBuilder)
        Select Case token.Type
                    ...
                    Case TokenType.COMMA:
                        sb.Append("{{\cf9 ")
                        Exit Select
                    Case TokenType.CONCATENATIONSYMBOL:
                        sb.Append("{{\cf10 ")
                        Exit Select
                    ...
                    Case TokenType.IDENTIFIER:
                        sb.Append("{{\cf22 ")
                        Exit Select
                    Case TokenType.INCOMPARITOR:
                        sb.Append("{{\cf23 ")
                        Exit Select
                    Case TokenType.INDIVIDUALNAME:
                        sb.Append("{{\cf24 ")
                        Exit Select
                    ...
                    Case TokenType.STAR:
                        sb.Append("{{\cf43 ")
                        Exit Select
                    Case TokenType.WHICHCLAUSEBROPEN:
                        sb.Append("{{\cf44 ")
                        Exit Select
                    Case TokenType.WHICHCLAUSEBRCLOSE:
                        sb.Append("{{\cf45 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDANYFACTTYPE:
                        sb.Append("{{\cf56 ")
                        Exit Select
                    Case TokenType.KEYWDASC:
                        sb.Append("{{\cf57 ")
                        Exit Select
                    Case TokenType.KEYWDASSERT:
                        sb.Append("{{\cf58 ")
                        Exit Select
                    Case TokenType.KEYWDAS:
                        sb.Append("{{\cf59 ")
                        Exit Select
                    Case TokenType.KEYWDATMOSTONE:
                        sb.Append("{{\cf60 ")
                        Exit Select
                    Case TokenType.KEYWDAVG:
                        sb.Append("{{\cf61 ")
                        Exit Select
                    Case TokenType.KEYWDBETWEEN:
                        sb.Append("{{\cf62 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDDATABASE:
                        sb.Append("{{\cf71 ")
                        Exit Select
                    Case TokenType.KEYWDDATE:
                        sb.Append("{{\cf72 ")
                        Exit Select
                    Case TokenType.KEYWDDESC:
                        sb.Append("{{\cf73 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDGET:
                        sb.Append("{{\cf130 ")
                        Exit Select
                    Case TokenType.KEYWDGROUPBY:
                        sb.Append("{{\cf131 ")
                        Exit Select
                    Case TokenType.KEYWDHAVING:
                        sb.Append("{{\cf132 ")
                        Exit Select
                    Case TokenType.KEYWDHOUR:
                        sb.Append("{{\cf133 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDSHOW:
                        sb.Append("{{\cf190 ")
                        Exit Select
                    Case TokenType.KEYWDSHOWME:
                        sb.Append("{{\cf191 ")
                        Exit Select
                    Case TokenType.KEYWDSTANDALONE:
                        sb.Append("{{\cf192 ")
                        Exit Select
                    Case TokenType.KEYWDSUM:
                        sb.Append("{{\cf193 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDTODAY:
                        sb.Append("{{\cf201 ")
                        Exit Select
                    Case TokenType.KEYWDTOMORROW:
                        sb.Append("{{\cf202 ")
                        Exit Select
                    Case TokenType.KEYWDTOLOWER:
                        sb.Append("{{\cf203 ")
                        Exit Select
                    Case TokenType.KEYWDTOUPPER:
                        sb.Append("{{\cf204 ")
                        Exit Select
                    ...
                    Case TokenType.KEYWDWHAT:
                        sb.Append("{{\cf214 ")
                        Exit Select
                    Case TokenType.KEYWDWHEREALSO:
                        sb.Append("{{\cf215 ")
                        Exit Select
                    Case TokenType.KEYWDWHICH:
                        sb.Append("{{\cf216 ")
                        Exit Select
                    Case TokenType.KEYWDWHO:
                        sb.Append("{{\cf217 ")
                        Exit Select
                    Case TokenType.KEYWDWRITTENAS:
                        sb.Append("{{\cf218 ")
                        Exit Select
                    Case TokenType.KEYWDYEAR:
                        sb.Append("{{\cf219 ")
                        Exit Select
                    Case TokenType.KEYWDPIECHART:
                        sb.Append("{{\cf220 ")
                        Exit Select
                    Case TokenType.KEYWDBARCHART:
                        sb.Append("{{\cf221 ")
                        Exit Select
                    Case TokenType.KEYWDLINECHART:
                        sb.Append("{{\cf222 ")
                        Exit Select
                    Case TokenType.KEYWDAREACHART:
                        sb.Append("{{\cf223 ")
                        Exit Select
                    Case TokenType.KEYWDSCATTERPLOT:
                        sb.Append("{{\cf224 ")
                        Exit Select
                    Case TokenType.PLUS:
                        sb.Append("{{\cf225 ")
                    ...
                    Case TokenType.KEYWDGREATERTHAN:
                        sb.Append("{{\cf231 ")
                        Exit Select
                    Case TokenType.KEYWDLESSTHANEQUALS:
                        sb.Append("{{\cf232 ")
                        Exit Select
                    Case TokenType.KEYWDGREATERTHANEQUALS:
                        sb.Append("{{\cf233 ")
                        Exit Select
                    Case TokenType.KEYWDDATEDIFF:
                        sb.Append("{{\cf234 ")
                        Exit Select
    ...
    Private Sub AddRtfHeader(ByVal sb As StringBuilder)
        sb.Insert(0, "{\rtf1\ansi\deff0{\fonttbl{\f0\fnil\fcharset0 Tahoma;}}{\colortbl;\red94\green213\blue165;\red94\green213\blue165;\red94\green213\blue165;\red94\green213\blue165;\red227\green143\blue247;\red227\green143\blue247;\red94\green213\blue165;\red255\green171\blue26;\red115\green190\blue213;\red115\green190\blue213;\red153\green0\blue0;\red153\green0\blue0;\red227\green143\blue247;\red227\green143\blue247;\red216\green127\blue178;\red153\green0\blue0;\red153\green0\blue0;\red216\green127\blue178;\red115\green190\blue213;\red227\green143\blue247;\red239\green180\blue149;\red216\green127\blue178;\red94\green213\blue165;\red94\green213\blue165;\red94\green213\blue165;\red216\green127\blue178;\red94\green213\blue165;\red94\green213\blue165;\red216\green127\blue178;\red227\green143\blue247;\red227\green143\blue247;\red227\green143\blue247;\red115\green190\blue213;\red154\green200\blue135;\red174\green203\blue145;\red227\green143\blue247;\red227\green143\blue247;\red76\green153\blue0;\red153\green76\blue0;\red227\green143\blue247;\red216\green127\blue178;\red0\green0\blue255;\red255\green171\blue26;\red94\green213\blue165;\red94\green213\blue165;\red153\green0\blue0;\red153\green0\blue0;\red115\green217\blue243;\red0\green0\blue255;\red0\green0\blue255;\red0\green0\blue255;\red115\green190\blue213;\red115\green217\blue243;\red115\green217\blue243;\red115\green217\blue243;\red115\green190\blue213;\red115\green217\blue243;\red115\green190\blue213;\red115\green190\blue213;\red0\green0\blue255;\red115\green190\blue213;\red115\green190\blue213;\red115\green190\blue213;\red115\green190\blue213;\red0\green0\blue255;\red115\green217\blue243;\red115\green190\blue213;\red105\green170\blue203;\red0\green0\blue255;\red115\green190\blue213;\red115\green190\blue213;\red115\green190\blue213;\red115\green217\blue243;\red0\green0\blue255;\red0\green0\blue255;\red0\green0\blue255;\red0\green0\blue255;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\green200\blue200;\red200\