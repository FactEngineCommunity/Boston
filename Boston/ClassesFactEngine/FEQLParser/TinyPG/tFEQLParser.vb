    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseNODESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: NODESTMT
            ...
            If tok.Type <> TokenType.ID Then
                m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.ID.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "ID"))
                Return
        ...
        Private Sub ParseNODEPROPERTYIDENTIFICATION(ByVal parent As ParseNode) ' NonTerminalSymbol: NODEPROPERTYIDENTIFICATION
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.COLON) ' Option Rule
            If tok.Type = TokenType.COLON Then
        ...
        Private Sub ParseWHICHSELECTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: WHICHSELECTSTMT
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDAND, TokenType.KEYWDWHICH, TokenType.KEYWDTHAT, TokenType.PREDICATE) ' ZeroOrMore Rule
            While tok.Type = TokenType.KEYWDAND Or tok.Type = TokenType.KEYWDWHICH Or tok.Type = TokenType.KEYWDTHAT Or tok.Type = TokenType.PREDICATE
