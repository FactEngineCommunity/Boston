    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseNODEPROPERTYIDENTIFICATION(ByVal parent As ParseNode) ' NonTerminalSymbol: NODEPROPERTYIDENTIFICATION
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.COLON) ' ZeroOrMore Rule
        ...
        Private Sub ParseNODEIDENTIFICATION(ByVal parent As ParseNode) ' NonTerminalSymbol: NODEIDENTIFICATION
            ...
            tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
        ...
        Private Sub ParseASSERTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: ASSERTSTMT
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDISWRITTENAS, TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISWRITTENAS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREBOUNDREADINGTEXT"))
        ...
        Private Sub ParseCREATESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: CREATESTMT
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN, TokenType.KEYWDENTITYTYPE, TokenType.KEYWDFACTTYPE, TokenType.KEYWDVALUETYPE) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.PREBOUNDREADINGTEXT
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREBOUNDREADINGTEXT"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "BROPEN"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDENTITYTYPE"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDFACTTYPE"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDVALUETYPE"))
                End If
                    m_tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found.", &H0002, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos))
                    Exit Select
            End Select ' Choice Rule
        ...
        Private Sub ParseDELETESTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: DELETESTMT
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN, TokenType.KEYWDFROM) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.PREBOUNDREADINGTEXT
                    ParseNODEPROPERTYIDENTIFICATION(node) ' NonTerminal Rule: NODEPROPERTYIDENTIFICATION
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREBOUNDREADINGTEXT"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "BROPEN"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.PREBOUNDREADINGTEXT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDFROM"))
                End If
                    m_tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found.", &H0002, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos))
                    Exit Select
            End Select ' Choice Rule
        ...
        Private Sub ParseFACTTYPEPRODUCTION(ByVal parent As ParseNode) ' NonTerminalSymbol: FACTTYPEPRODUCTION
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDISWRITTENAS, TokenType.KEYWDISIDENTIFIEDBYITS, TokenType.KEYWDISA, TokenType.KEYWDISWHERE, TokenType.PREDICATE) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.KEYWDISWRITTENAS
                    ParseVALUETYPEISWRITTENASSTMT(node) ' NonTerminal Rule: VALUETYPEISWRITTENASSTMT
            ...
            End If
                Case TokenType.KEYWDISA
                    ParseCONSTRAINTMANDATORY(node) ' NonTerminal Rule: CONSTRAINTMANDATORY
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDISWRITTENAS.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDISA"))
        ...
        Private Sub ParseTABLEIDENTIFICATION(ByVal parent As ParseNode) ' NonTerminalSymbol: TABLEIDENTIFICATION
            ...
            End If
                 ...
                 ' Concat Rule
                tok = m_scanner.LookAhead(TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN, TokenType.KEYWDWHICH) ' Choice Rule
                Select Case tok.Type
                 ' Choice Rule
                    Case TokenType.PREBOUNDREADINGTEXT
        ...
        Private Sub ParseWHICHCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: WHICHCLAUSE
            ...
            tok = m_scanner.LookAhead(TokenType.KEYWDWITH, TokenType.KEYWDAND, TokenType.KEYWDWHICH, TokenType.KEYWDIS, TokenType.PREDICATE, TokenType.KEYWDTHAT, TokenType.PREBOUNDREADINGTEXT, TokenType.MODELELEMENTNAME, TokenType.KEYWDA, TokenType.BROPEN) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
            ...
            End If
                     ...
                     ' Concat Rule
                    tok = m_scanner.LookAhead(TokenType.KEYWDWHICH, TokenType.KEYWDTHAT, TokenType.KEYWDA, TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN) ' Option Rule
                    If tok.Type = TokenType.KEYWDWHICH Or tok.Type = TokenType.KEYWDTHAT Or tok.Type = TokenType.KEYWDA Or tok.Type = TokenType.PREBOUNDREADINGTEXT Or tok.Type = TokenType.BROPEN Then
                        tok = m_scanner.LookAhead(TokenType.KEYWDWHICH, TokenType.KEYWDTHAT, TokenType.KEYWDA, TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN) ' Choice Rule
                        Select Case tok.Type
                         ' Choice Rule
                            Case TokenType.KEYWDWHICH

                                 ' Concat Rule
                                tok = m_scanner.LookAhead(TokenType.KEYWDWHICH, TokenType.KEYWDTHAT, TokenType.KEYWDA) ' Choice Rule
                                Select Case tok.Type
                                 ' Choice Rule
                                    Case TokenType.KEYWDWHICH
                                        tok = m_scanner.Scan(TokenType.KEYWDWHICH) ' Terminal Rule: KEYWDWHICH
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDWITH.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDAND"))
        ...
        Private Sub ParseWITHCLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: WITHCLAUSE
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.MODELELEMENTNAME, TokenType.PREBOUNDREADINGTEXT, TokenType.BROPEN) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.MODELELEMENTNAME
                    tok = m_scanner.Scan(TokenType.MODELELEMENTNAME) ' Terminal Rule: MODELELEMENTNAME
            ...
            End If
                ...
                m_tree.Optionals.Clear
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.MODELELEMENTNAME.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "MODELELEMENTNAME"))
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.MODELELEMENTNAME.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "PREBOUNDREADINGTEXT"))
        ...
        Private Sub ParseWHICHSELECTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: WHICHSELECTSTMT
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDWITH, TokenType.KEYWDAND, TokenType.KEYWDWHICH, TokenType.KEYWDIS, TokenType.PREDICATE, TokenType.KEYWDTHAT, TokenType.PREBOUNDREADINGTEXT, TokenType.MODELELEMENTNAME, TokenType.KEYWDA, TokenType.BROPEN) ' ZeroOrMore Rule
            While tok.Type = TokenType.KEYWDWITH Or tok.Type = TokenType.KEYWDAND Or tok.Type = TokenType.KEYWDWHICH Or tok.Type = TokenType.KEYWDIS Or tok.Type = TokenType.PREDICATE Or tok.Type = TokenType.KEYWDTHAT Or tok.Type = TokenType.PREBOUNDREADINGTEXT Or tok.Type = TokenType.MODELELEMENTNAME Or tok.Type = TokenType.KEYWDA Or tok.Type = TokenType.BROPEN
