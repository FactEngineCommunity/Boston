    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseRECURSIVECLAUSE(ByVal parent As ParseNode) ' NonTerminalSymbol: RECURSIVECLAUSE
            ...
            End If
             ...
             ' Concat Rule
            tok = m_scanner.LookAhead(TokenType.KEYWDCIRCULAR, TokenType.NUMBER, TokenType.PERIOD) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
            ...
            Select Case tok.Type
             ' Choice Rule
                Case TokenType.KEYWDCONNECTTOMODEL
                    ParseCONNECTTOMODELSTMT(node) ' NonTerminal Rule: CONNECTTOMODELSTMT
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
