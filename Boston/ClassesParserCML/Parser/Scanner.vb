...
#Region "Scanner"
    ...
    Partial Public Class Scanner
        ...
        Public Sub New()
            ...
            regex = new Regex("(?!onlyif)[a-z][a-zA-Z|\s]+$", RegexOptions.Compiled)
            ...
            regex = new Regex("(?!onlyif)(?>[a-z|\s]+ )(?<!$)", RegexOptions.Compiled)
            ...
            Patterns.Add(TokenType.SUBSCRIPT, regex)
            Tokens.Add(TokenType.SUBSCRIPT)
            ...
            regex = new Regex("\*s?[a-zA-Z\s]+$?", RegexOptions.Compiled)
            Patterns.Add(TokenType.COMMENTBODY, regex)
            Tokens.Add(TokenType.COMMENTBODY)

            regex = new Regex("s?\*\/", RegexOptions.Compiled)
            Patterns.Add(TokenType.COMMENTEND, regex)
            Tokens.Add(TokenType.COMMENTEND)

            regex = new Regex("\/\*s?$?", RegexOptions.Compiled)
            Patterns.Add(TokenType.COMMENTSTART, regex)
            Tokens.Add(TokenType.COMMENTSTART)
            ...
            regex = new Regex(" onlyif", RegexOptions.Compiled)
            Patterns.Add(TokenType.KEYWDONLYIF, regex)
            Tokens.Add(TokenType.KEYWDONLYIF)
...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        'Non terminal tokens:
        MODELELEMENTLEADINGSTMT= 2
        BINARYPREDICATECLAUSE= 3
        COMMENTCLAUSE= 4
        FACTREADING = 5
        FRONTREADINGTEXTCLAUSE= 6
        MODELELEMENT= 7
        PREDICATECLAUSE= 8
        SUBTYPECLAUSE= 9
        UNARYPREDICATECLAUSE= 10
        VALUETYPECLAUSE= 11
        Start       = 12

        'Terminal tokens:
        EOF         = 13
        FOLLOWINGREADINGTEXT= 14
        FRONTREADINGTEXT= 15
        MODELELEMENTNAME= 16
        PREDICATEPART= 17
        PREDICATESPACE= 18
        PREBOUNDREADINGTEXT= 19
        POSTBOUNDREADINGTEXT= 20
        SUBSCRIPT   = 21
        UNARYPREDICATEPART= 22
        COMMENTBODY = 23
        COMMENTEND  = 24
        COMMENTSTART= 25
        KEYWDISWRITTENAS= 26
