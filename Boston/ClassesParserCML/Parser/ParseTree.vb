...
#Region "ParseNode"
	...
	End Sub 
        ...
        Friend Function Eval(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            ...
            Select Case Token.Type
                ...
                Case TokenType.BINARYPREDICATECLAUSE
                    ...
                    Exit Select
                Case TokenType.COMMENTCLAUSE
                    Value = EvalCOMMENTCLAUSE(tree, paramlist)
                    Exit Select
                ...
                Case TokenType.UNARYPREDICATECLAUSE
                    ...
                    Exit Select
                Case TokenType.VALUETYPECLAUSE
                    Value = EvalVALUETYPECLAUSE(tree, paramlist)
                    Exit Select
        ...
        Protected Overridable Function EvalCOMMENTCLAUSE(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
        ...
        Protected Overridable Function EvalVALUETYPECLAUSE(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
