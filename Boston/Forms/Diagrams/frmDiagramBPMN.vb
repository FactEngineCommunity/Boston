...
Public Class frmDiagramBPMN
    ...
    Dim columns As MindFusion.Diagramming.Lanes.HeaderCollection
    ...
    Sub LoadEventTraceDiagramPage(ByRef arPage As FBM.Page)
        ...
        Me.zrPage.UMLDiagram.Actor.Sort(AddressOf CMML.Actor.CompareSequenceNrs)
        For Each lrActorInSequence In Me.zrPage.UMLDiagram.Actor
            header = New Header(lrActorInSequence.Name)
            Me.columns.Add(header)
            header.Width = Me.Diagram.Bounds.Width / Me.zrPage.UMLDiagram.Actor.Count
    ...
    Sub SetToolbox()
        ...
        Dim lsl_shape_library As ShapeLibrary = ShapeLibrary.LoadFrom(My.Settings.BPMNShapeLibraryCore)
