...
Public Class frmCRUDAddRole

    Private zrRole As New ClientServer.Role
    ...
    Private Sub ButtonOkay_Click(sender As Object, e As EventArgs) Handles ButtonOkay.Click
        ...
        If Me.checkFields() Then
            If Me.getFields(Me.zrRole) Then
                ...
                Call tableClientServerRole.addRole(Me.zrRole)

                Dim liFunction As pcenumFunction
                For Each lrComboboxItem In Me.ListBoxIncludedFunctions.Items
                    liFunction = lrComboboxItem.Tag
        ...
        Try
            ...
            If Not lREcordset.EOF Then
                While Not lREcordset.EOF
                    ...
                    Dim lrComboboxItem As New tComboboxItem(liFunction.ToString, liFunction.ToString, liFunction)
