Public Class frmCRUDEditAttribute
    ...
    Private Sub SetupForm()
        ...
        Me.ComboBoxAttribute.Text = "NewAttribute"
        Me.ComboBoxAttribute.SelectAll()

        Me.zrFactType = New FBM.FactType(Me.zrModel, Me.zrModelObject.Name & "NewAttribute", True)

        '--------------------------------------------------------------------------------
        'Create a new ValueType (in anticipation of [OK] button press) within the Model
        '--------------------------------------------------------------------------------
        Me.zrValueType = Me.zrModel.CreateValueType
        Me.zrValueType.SetName("NewAttribute")
    ...
    Private Sub LoadObjectTypes()
        ...
        Me.ComboBoxObjectType.Items.Add(New tComboboxItem("Entity Type", "Entity Type", New FBM.DictionaryEntry(Me.zrFactType.Model, "EntityType", pcenumConceptType.EntityType)))
        Me.ComboBoxObjectType.Items.Add(New tComboboxItem("Value Type", "Value Type", New FBM.DictionaryEntry(Me.zrFactType.Model, "ValueType", pcenumConceptType.ValueType)))
    ...
    Private Sub ComboBoxAttribute_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComboBoxAttribute.TextChanged
