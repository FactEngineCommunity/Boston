            ...
            Select Case ExecNode.Action
                ...
                Case SyntaxNode.ExecActions.ACTION_FOR
                    ...
                    Select Case ExecNode.ForEntity
                        ...
                        Case SyntaxNode.ExecForEntities.OBJECT_INDEX 'Boston specific. Not part of original metadrone.
                            Call Me.AddVar(AsMain, New Variable(ExecNode.Tokens(2).Text, Variable.Types.Index, Me.varScopeDepth, sourceTag))
