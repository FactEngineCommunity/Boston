...
#Region "Scanner"
    ...
    Partial Public Class Scanner
        ...
        Public Sub New()
            ...
            regex = new Regex("(([A-Z0-9]+[_a-z\-0-9]*[ |_]*)+[_|\s]?)+", RegexOptions.Compiled)
            Patterns.Add(TokenType.MODELELEMENTNAME2, regex)
            Tokens.Add(TokenType.MODELELEMENTNAME2)
...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        MODELNAME   = 61
        MODELELEMENTNAME= 62
        MODELELEMENTNAME2= 63
        MODELID     = 64
        NUMBER      = 65
        PERIOD      = 66
        PLUSMINUS   = 67
        PAGENAME    = 68
        POSTBOUNDREADINGTEXT= 69
        PREBOUNDREADINGTEXT= 70
        PREDICATEPART= 71
        PREDICATESPACE= 72
        REFERENCEMODE= 73
        ROLENAME    = 74
        ...
        STAR        = 76
        SPACE       = 77
        UNARYPREDICATEPART= 78
        USERTABLENAME= 79
        VALUECONSTRAINTVALUE= 80
        WHERECLAUSECOLUMNNAMESTR= 81
        VALUE       = 82
        KEYWDADDOBJECTTYPE= 83
        KEYWDADDOBJECTTYPESRELATEDTO= 84
        KEYWDANYNUMBEROF= 85
        KEYWDANYFACTTYPE= 86
        KEYWDATLEASTONE= 87
        KEYWDATMOSTONE= 88
        ...
        KEYWDISA    = 91
        KEYWDISWHERE= 92
        KEYWDDATATYPELOGICALTRUEFALSE= 93
        KEYWDDATATYPELOGICALYESNO= 94
        KEYWDDATATYPEAUTOCOUNTER= 95
        KEYWDDATATYPEDECIMAL= 96
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 97
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 98
        KEYWDDATATYPEFLOATSINGLEPRECISION= 99
        KEYWDDATATYPEMONEY= 100
        KEYWDDATATYPESIGNEDBIGINTEGER= 101
        KEYWDDATATYPESIGNEDINTEGER= 102
        KEYWDDATATYPESIGNEDSMALLINTEGER= 103
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 104
        KEYWDDATATYPEUNSIGNEDINTEGER= 105
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 106
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 107
        KEYWDDATATYPEOBJECTID= 108
        KEYWDDATATYPEROWID= 109
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 110
        KEYWDDATATYPERAWDATALARGELENGTH= 111
        KEYWDDATATYPERAWDATAOLEOBJECT= 112
        KEYWDDATATYPERAWDATA= 113
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 114
        KEYWDDATATYPEAUTOTIMESTAMP= 115
        KEYWDDATATYPEDATE= 116
        KEYWDDATATYPEDATETIME= 117
        KEYWDDATATYPETIME= 118
        KEYWDDATATYPESTRINGFIXEDLENGTH= 119
        KEYWDDATATYPESTRINGLARGELENGTH= 120
        KEYWDDATATYPESTRINGVARIABLELENGTH= 121
        KEYWDIDENTIFIEDBYITS= 122
        KEYWDISACONCEPT= 123
        KEYWDISAKINDOF= 124
        KEYWDISANENTITYTYPE= 125
        KEYWDISAVALUETYPE= 126
        KEYWDISIDENTIFIEDBYITS= 127
        KEYWDISWRITTENAS= 128
        KEYWDNL     = 129
        KEYWDONE    = 130
        KEYWDPAGE   = 131
        KEYWDREADING= 132
