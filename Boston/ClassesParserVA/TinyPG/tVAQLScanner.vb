...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        MODELELEMENTTYPE= 16
        PREDICATECLAUSE= 17
        UNARYPREDICATECLAUSE= 18
        VALUETYPEISWRITTENASCLAUSE= 19
        VALUETYPEWRITTENASCLAUSE= 20
        FACTTYPEIDENTIFICATION= 21
        FACTTYPESTMT= 22
        FACTREADINGSTMT= 23
        MODELELEMENTLEADINGSTMT= 24
        BASEPRODUCTION= 25
        Start       = 26
        ...
        COLUMNNAMESTR= 30
        COMMA       = 31
        CURLYBRACKETCLOSE= 32
        CURLYBRACKETOPEN= 33
        DOUBLEQUOTE = 34
        EOF         = 35
        EQUALS      = 36
        FACTTYPENAME= 37
        FOLLOWINGREADINGTEXT= 38
        FRONTREADINGTEXT= 39
        ID          = 40
        MULTDIV     = 41
        MODELNAME   = 42
        ...
        PAGENAME    = 46
        PLUSMINUS   = 47
        POSTBOUNDREADINGTEXT= 48
        PREBOUNDREADINGTEXT= 49
        PREDICATEPART= 50
        PREDICATESPACE= 51
        REFERENCEMODE= 52
        ROLENAME    = 53
        ...
        STAR        = 55
        SPACE       = 56
        UNARYPREDICATEPART= 57
        USERTABLENAME= 58
        WHERECLAUSECOLUMNNAMESTR= 59
        VALUE       = 60
        KEYWDATMOSTONE= 61
        KEYWDISA    = 62
        KEYWDISWHERE= 63
        KEYWDDATATYPELOGICALTRUEFALSE= 64
        KEYWDDATATYPELOGICALYESNO= 65
        KEYWDDATATYPEAUTOCOUNTER= 66
        KEYWDDATATYPEDECIMAL= 67
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 68
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 69
        KEYWDDATATYPEFLOATSINGLEPRECISION= 70
        KEYWDDATATYPEMONEY= 71
        KEYWDDATATYPESIGNEDBIGINTEGER= 72
        KEYWDDATATYPESIGNEDINTEGER= 73
        KEYWDDATATYPESIGNEDSMALLINTEGER= 74
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 75
        KEYWDDATATYPEUNSIGNEDINTEGER= 76
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 77
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 78
        KEYWDDATATYPEOBJECTID= 79
        KEYWDDATATYPEROWID= 80
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 81
        KEYWDDATATYPERAWDATALARGELENGTH= 82
        KEYWDDATATYPERAWDATAOLEOBJECT= 83
        KEYWDDATATYPERAWDATA= 84
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 85
        KEYWDDATATYPEAUTOTIMESTAMP= 86
        KEYWDDATATYPEDATE= 87
        KEYWDDATATYPEDATETIME= 88
        KEYWDDATATYPETIME= 89
        KEYWDDATATYPESTRINGFIXEDLENGTH= 90
        KEYWDDATATYPESTRINGLARGELENGTH= 91
        KEYWDDATATYPESTRINGVARIABLELENGTH= 92
        KEYWDIDENTIFIEDBYITS= 93
        KEYWDISACONCEPT= 94
        KEYWDISAKINDOF= 95
        KEYWDISANENTITYTYPE= 96
        KEYWDISIDENTIFIEDBYITS= 97
        KEYWDISWRITTENAS= 98
        KEYWDNL     = 99
        KEYWDONE    = 100
        KEYWDREADING= 101
