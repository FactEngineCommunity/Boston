...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        ENTITYTYPEIDENTIFIEDBYITSCLAUSE= 10
        FACTTYPECLAUSE= 11
        FRONTREADINGTEXTCLAUSE= 12
        ISACONCEPTCLAUSE= 13
        ISANENTITYTYPECLAUSE= 14
        ISAVALUETYPECLAUSE= 15
        MODELELEMENT= 16
        MODELELEMENTTYPE= 17
        PREDICATECLAUSE= 18
        UNARYPREDICATECLAUSE= 19
        VALUETYPEISWRITTENASCLAUSE= 20
        VALUETYPEWRITTENASCLAUSE= 21
        FACTTYPEIDENTIFICATION= 22
        FACTTYPESTMT= 23
        FACTREADINGSTMT= 24
        MODELELEMENTLEADINGSTMT= 25
        BASEPRODUCTION= 26
        Start       = 27
        ...
        COLUMNNAMESTR= 31
        COMMA       = 32
        CURLYBRACKETCLOSE= 33
        CURLYBRACKETOPEN= 34
        DOUBLEQUOTE = 35
        EOF         = 36
        EQUALS      = 37
        FACTTYPENAME= 38
        FOLLOWINGREADINGTEXT= 39
        FRONTREADINGTEXT= 40
        ID          = 41
        MULTDIV     = 42
        MODELNAME   = 43
        ...
        PAGENAME    = 47
        PLUSMINUS   = 48
        POSTBOUNDREADINGTEXT= 49
        PREBOUNDREADINGTEXT= 50
        PREDICATEPART= 51
        PREDICATESPACE= 52
        REFERENCEMODE= 53
        ROLENAME    = 54
        ...
        STAR        = 56
        SPACE       = 57
        UNARYPREDICATEPART= 58
        USERTABLENAME= 59
        WHERECLAUSECOLUMNNAMESTR= 60
        VALUE       = 61
        KEYWDATMOSTONE= 62
        KEYWDISA    = 63
        KEYWDISWHERE= 64
        KEYWDDATATYPELOGICALTRUEFALSE= 65
        KEYWDDATATYPELOGICALYESNO= 66
        KEYWDDATATYPEAUTOCOUNTER= 67
        KEYWDDATATYPEDECIMAL= 68
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 69
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 70
        KEYWDDATATYPEFLOATSINGLEPRECISION= 71
        KEYWDDATATYPEMONEY= 72
        KEYWDDATATYPESIGNEDBIGINTEGER= 73
        KEYWDDATATYPESIGNEDINTEGER= 74
        KEYWDDATATYPESIGNEDSMALLINTEGER= 75
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 76
        KEYWDDATATYPEUNSIGNEDINTEGER= 77
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 78
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 79
        KEYWDDATATYPEOBJECTID= 80
        KEYWDDATATYPEROWID= 81
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 82
        KEYWDDATATYPERAWDATALARGELENGTH= 83
        KEYWDDATATYPERAWDATAOLEOBJECT= 84
        KEYWDDATATYPERAWDATA= 85
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 86
        KEYWDDATATYPEAUTOTIMESTAMP= 87
        KEYWDDATATYPEDATE= 88
        KEYWDDATATYPEDATETIME= 89
        KEYWDDATATYPETIME= 90
        KEYWDDATATYPESTRINGFIXEDLENGTH= 91
        KEYWDDATATYPESTRINGLARGELENGTH= 92
        KEYWDDATATYPESTRINGVARIABLELENGTH= 93
        KEYWDIDENTIFIEDBYITS= 94
        KEYWDISACONCEPT= 95
        KEYWDISAKINDOF= 96
        KEYWDISANENTITYTYPE= 97
        KEYWDISAVALUETYPE= 98
        KEYWDISIDENTIFIEDBYITS= 99
        KEYWDISWRITTENAS= 100
        KEYWDNL     = 101
        KEYWDONE    = 102
        KEYWDREADING= 103
        KEYWDWRITTENAS= 104
