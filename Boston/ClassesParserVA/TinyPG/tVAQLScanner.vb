...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        BINARYFACTTYPEANYNUMBEROFCLAUSE= 3
        BINARYFACTTYPEATLEASTONECLAUSE= 4
        BINARYFACTTYPEATMOSTONECLAUSE= 5
        BINARYFACTTYPEMANYTOONEDEFINITIONCLAUSE= 6
        BINARYPREDICATECLAUSE= 7
        DATATYPE    = 8
        DATATYPELENGTH= 9
        DATATYPEPRECISION= 10
        ENTITYTYPEISIDENTIFIEDBYITSCLAUSE= 11
        ENTITYTYPEIDENTIFIEDBYITSCLAUSE= 12
        FACTTYPECLAUSE= 13
        FRONTREADINGTEXTCLAUSE= 14
        ISACONCEPTCLAUSE= 15
        ISANENTITYTYPECLAUSE= 16
        ISAVALUETYPECLAUSE= 17
        MODELELEMENT= 18
        MODELELEMENTTYPE= 19
        PREDICATECLAUSE= 20
        UNARYPREDICATECLAUSE= 21
        VALUETYPEISWRITTENASCLAUSE= 22
        VALUETYPEWRITTENASCLAUSE= 23
        FACTTYPEIDENTIFICATION= 24
        FACTTYPESTMT= 25
        FACTREADINGSTMT= 26
        MODELELEMENTLEADINGSTMT= 27
        BASEPRODUCTION= 28
        Start       = 29
        ...
        COLUMNNAMESTR= 33
        COMMA       = 34
        CURLYBRACKETCLOSE= 35
        CURLYBRACKETOPEN= 36
        DOUBLEQUOTE = 37
        EOF         = 38
        EQUALS      = 39
        FACTTYPENAME= 40
        FOLLOWINGREADINGTEXT= 41
        FRONTREADINGTEXT= 42
        ID          = 43
        MULTDIV     = 44
        MODELNAME   = 45
        ...
        PAGENAME    = 49
        PLUSMINUS   = 50
        POSTBOUNDREADINGTEXT= 51
        PREBOUNDREADINGTEXT= 52
        PREDICATEPART= 53
        PREDICATESPACE= 54
        REFERENCEMODE= 55
        ROLENAME    = 56
        ...
        STAR        = 58
        SPACE       = 59
        UNARYPREDICATEPART= 60
        USERTABLENAME= 61
        WHERECLAUSECOLUMNNAMESTR= 62
        VALUE       = 63
        KEYWDANYNUMBEROF= 64
        KEYWDATLEASTONE= 65
        KEYWDATMOSTONE= 66
        KEYWDISA    = 67
        KEYWDISWHERE= 68
        KEYWDDATATYPELOGICALTRUEFALSE= 69
        KEYWDDATATYPELOGICALYESNO= 70
        KEYWDDATATYPEAUTOCOUNTER= 71
        KEYWDDATATYPEDECIMAL= 72
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 73
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 74
        KEYWDDATATYPEFLOATSINGLEPRECISION= 75
        KEYWDDATATYPEMONEY= 76
        KEYWDDATATYPESIGNEDBIGINTEGER= 77
        KEYWDDATATYPESIGNEDINTEGER= 78
        KEYWDDATATYPESIGNEDSMALLINTEGER= 79
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 80
        KEYWDDATATYPEUNSIGNEDINTEGER= 81
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 82
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 83
        KEYWDDATATYPEOBJECTID= 84
        KEYWDDATATYPEROWID= 85
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 86
        KEYWDDATATYPERAWDATALARGELENGTH= 87
        KEYWDDATATYPERAWDATAOLEOBJECT= 88
        KEYWDDATATYPERAWDATA= 89
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 90
        KEYWDDATATYPEAUTOTIMESTAMP= 91
        KEYWDDATATYPEDATE= 92
        KEYWDDATATYPEDATETIME= 93
        KEYWDDATATYPETIME= 94
        KEYWDDATATYPESTRINGFIXEDLENGTH= 95
        KEYWDDATATYPESTRINGLARGELENGTH= 96
        KEYWDDATATYPESTRINGVARIABLELENGTH= 97
        KEYWDIDENTIFIEDBYITS= 98
        KEYWDISACONCEPT= 99
        KEYWDISAKINDOF= 100
        KEYWDISANENTITYTYPE= 101
        KEYWDISAVALUETYPE= 102
        KEYWDISIDENTIFIEDBYITS= 103
        KEYWDISWRITTENAS= 104
        KEYWDNL     = 105
        KEYWDONE    = 106
        KEYWDREADING= 107
        KEYWDWRITTENAS= 108
