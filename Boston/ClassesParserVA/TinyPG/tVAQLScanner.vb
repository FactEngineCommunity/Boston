...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        ISACONCEPTCLAUSE= 20
        ISANENTITYTYPECLAUSE= 21
        ISAVALUETYPECLAUSE= 22
        ISWHERECLAUSE= 23
        MODELELEMENT= 24
        MODELELEMENTTYPE= 25
        OBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE= 26
        PREDICATECLAUSE= 27
        UNARYPREDICATECLAUSE= 28
        VALUECONSTRAINTCLAUSE= 29
        VALUECONSTRAINTVALUELIST= 30
        VALUETYPEISWRITTENASCLAUSE= 31
        VALUETYPEWRITTENASCLAUSE= 32
        FACTTYPEIDENTIFICATION= 33
        FACTTYPESTMT= 34
        FACTREADINGSTMT= 35
        MODELELEMENTLEADINGSTMT= 36
        BASEPRODUCTION= 37
        Start       = 38
        ...
        COLUMNNAMESTR= 42
        COMMA       = 43
        CURLYBRACKETCLOSE= 44
        CURLYBRACKETOPEN= 45
        DOUBLEQUOTE = 46
        EOF         = 47
        EQUALS      = 48
        FACTTYPENAME= 49
        FOLLOWINGREADINGTEXT= 50
        FRONTREADINGTEXT= 51
        ID          = 52
        MULTDIV     = 53
        MODELNAME   = 54
        ...
        PERIOD      = 59
        PLUSMINUS   = 60
        POSTBOUNDREADINGTEXT= 61
        PREBOUNDREADINGTEXT= 62
        PREDICATEPART= 63
        PREDICATESPACE= 64
        REFERENCEMODE= 65
        ROLENAME    = 66
        ...
        STAR        = 68
        SPACE       = 69
        UNARYPREDICATEPART= 70
        USERTABLENAME= 71
        VALUECONSTRAINTVALUE= 72
        WHERECLAUSECOLUMNNAMESTR= 73
        VALUE       = 74
        KEYWDANYNUMBEROF= 75
        KEYWDATLEASTONE= 76
        KEYWDATMOSTONE= 77
        ...
        KEYWDISA    = 79
        KEYWDISWHERE= 80
        KEYWDDATATYPELOGICALTRUEFALSE= 81
        KEYWDDATATYPELOGICALYESNO= 82
        KEYWDDATATYPEAUTOCOUNTER= 83
        KEYWDDATATYPEDECIMAL= 84
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 85
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 86
        KEYWDDATATYPEFLOATSINGLEPRECISION= 87
        KEYWDDATATYPEMONEY= 88
        KEYWDDATATYPESIGNEDBIGINTEGER= 89
        KEYWDDATATYPESIGNEDINTEGER= 90
        KEYWDDATATYPESIGNEDSMALLINTEGER= 91
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 92
        KEYWDDATATYPEUNSIGNEDINTEGER= 93
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 94
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 95
        KEYWDDATATYPEOBJECTID= 96
        KEYWDDATATYPEROWID= 97
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 98
        KEYWDDATATYPERAWDATALARGELENGTH= 99
        KEYWDDATATYPERAWDATAOLEOBJECT= 100
        KEYWDDATATYPERAWDATA= 101
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 102
        KEYWDDATATYPEAUTOTIMESTAMP= 103
        KEYWDDATATYPEDATE= 104
        KEYWDDATATYPEDATETIME= 105
        KEYWDDATATYPETIME= 106
        KEYWDDATATYPESTRINGFIXEDLENGTH= 107
        KEYWDDATATYPESTRINGLARGELENGTH= 108
        KEYWDDATATYPESTRINGVARIABLELENGTH= 109
        KEYWDIDENTIFIEDBYITS= 110
        KEYWDISACONCEPT= 111
        KEYWDISAKINDOF= 112
        KEYWDISANENTITYTYPE= 113
        KEYWDISAVALUETYPE= 114
        KEYWDISIDENTIFIEDBYITS= 115
        KEYWDISWRITTENAS= 116
        KEYWDNL     = 117
        KEYWDONE    = 118
        KEYWDREADING= 119
        KEYWDWRITTENAS= 120
