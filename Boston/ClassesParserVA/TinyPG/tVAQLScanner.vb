...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        MODELELEMENT= 20
        MODELELEMENTTYPE= 21
        OBJECTIFIEDFACTTYPEISIDENTIFIEDBYITSCLAUSE= 22
        PREDICATECLAUSE= 23
        UNARYPREDICATECLAUSE= 24
        VALUECONSTRAINTCLAUSE= 25
        VALUECONSTRAINTVALUELIST= 26
        VALUETYPEISWRITTENASCLAUSE= 27
        VALUETYPEWRITTENASCLAUSE= 28
        FACTTYPEIDENTIFICATION= 29
        FACTTYPESTMT= 30
        FACTREADINGSTMT= 31
        MODELELEMENTLEADINGSTMT= 32
        BASEPRODUCTION= 33
        Start       = 34
        ...
        COLUMNNAMESTR= 38
        COMMA       = 39
        CURLYBRACKETCLOSE= 40
        CURLYBRACKETOPEN= 41
        DOUBLEQUOTE = 42
        EOF         = 43
        EQUALS      = 44
        FACTTYPENAME= 45
        FOLLOWINGREADINGTEXT= 46
        FRONTREADINGTEXT= 47
        ID          = 48
        MULTDIV     = 49
        MODELNAME   = 50
        ...
        PAGENAME    = 54
        PLUSMINUS   = 55
        POSTBOUNDREADINGTEXT= 56
        PREBOUNDREADINGTEXT= 57
        PREDICATEPART= 58
        PREDICATESPACE= 59
        REFERENCEMODE= 60
        ROLENAME    = 61
        ...
        STAR        = 63
        SPACE       = 64
        UNARYPREDICATEPART= 65
        USERTABLENAME= 66
        VALUECONSTRAINTVALUE= 67
        WHERECLAUSECOLUMNNAMESTR= 68
        VALUE       = 69
        KEYWDANYNUMBEROF= 70
        KEYWDATLEASTONE= 71
        KEYWDATMOSTONE= 72
        ...
        KEYWDISA    = 74
        KEYWDISWHERE= 75
        KEYWDDATATYPELOGICALTRUEFALSE= 76
        KEYWDDATATYPELOGICALYESNO= 77
        KEYWDDATATYPEAUTOCOUNTER= 78
        KEYWDDATATYPEDECIMAL= 79
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 80
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 81
        KEYWDDATATYPEFLOATSINGLEPRECISION= 82
        KEYWDDATATYPEMONEY= 83
        KEYWDDATATYPESIGNEDBIGINTEGER= 84
        KEYWDDATATYPESIGNEDINTEGER= 85
        KEYWDDATATYPESIGNEDSMALLINTEGER= 86
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 87
        KEYWDDATATYPEUNSIGNEDINTEGER= 88
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 89
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 90
        KEYWDDATATYPEOBJECTID= 91
        KEYWDDATATYPEROWID= 92
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 93
        KEYWDDATATYPERAWDATALARGELENGTH= 94
        KEYWDDATATYPERAWDATAOLEOBJECT= 95
        KEYWDDATATYPERAWDATA= 96
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 97
        KEYWDDATATYPEAUTOTIMESTAMP= 98
        KEYWDDATATYPEDATE= 99
        KEYWDDATATYPEDATETIME= 100
        KEYWDDATATYPETIME= 101
        KEYWDDATATYPESTRINGFIXEDLENGTH= 102
        KEYWDDATATYPESTRINGLARGELENGTH= 103
        KEYWDDATATYPESTRINGVARIABLELENGTH= 104
        KEYWDIDENTIFIEDBYITS= 105
        KEYWDISACONCEPT= 106
        KEYWDISAKINDOF= 107
        KEYWDISANENTITYTYPE= 108
        KEYWDISAVALUETYPE= 109
        KEYWDISIDENTIFIEDBYITS= 110
        KEYWDISWRITTENAS= 111
        KEYWDNL     = 112
        KEYWDONE    = 113
        KEYWDREADING= 114
        KEYWDWRITTENAS= 115
