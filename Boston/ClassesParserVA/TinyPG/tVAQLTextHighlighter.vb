    ...
    Private Sub HighlightToken(ByVal token As Token, ByVal sb As StringBuilder)
        Select Case token.Type
                    ...
                    Case TokenType.MODELELEMENTNAME:
                        sb.Append("{{\cf4 ")
                        Exit Select
                    Case TokenType.MODELELEMENTNAME2:
                        sb.Append("{{\cf5 ")
                        Exit Select
