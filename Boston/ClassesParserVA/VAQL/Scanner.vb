...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        MODELELEMENT= 13
        PREDICATECLAUSE= 14
        UNARYPREDICATECLAUSE= 15
        VALUETYPEISWRITTENASCLAUSE= 16
        FACTREADINGSTMT= 17
        MODELELEMENTLEADINGSTMT= 18
        BASEPRODUCTION= 19
        Start       = 20
        ...
        COLUMNNAMESTR= 24
        COMMA       = 25
        CURLYBRACKETCLOSE= 26
        CURLYBRACKETOPEN= 27
        DOUBLEQUOTE = 28
        EOF         = 29
        EQUALS      = 30
        FACTTYPENAME= 31
        FOLLOWINGREADINGTEXT= 32
        FRONTREADINGTEXT= 33
        ID          = 34
        MULTDIV     = 35
        MODELNAME   = 36
        ...
        PAGENAME    = 40
        PLUSMINUS   = 41
        POSTBOUNDREADINGTEXT= 42
        PREBOUNDREADINGTEXT= 43
        PREDICATEPART= 44
        PREDICATESPACE= 45
        REFERENCEMODE= 46
        ROLENAME    = 47
        ...
        STAR        = 49
        SPACE       = 50
        UNARYPREDICATEPART= 51
        USERTABLENAME= 52
        WHERECLAUSECOLUMNNAMESTR= 53
        VALUE       = 54
        KEYWDATMOSTONE= 55
        KEYWDDATATYPELOGICALTRUEFALSE= 56
        KEYWDDATATYPELOGICALYESNO= 57
        KEYWDDATATYPEAUTOCOUNTER= 58
        KEYWDDATATYPEDECIMAL= 59
        KEYWDDATATYPEFLOATCUSTOMPRECISION= 60
        KEYWDDATATYPEFLOATDOUBLEPRECISION= 61
        KEYWDDATATYPEFLOATSINGLEPRECISION= 62
        KEYWDDATATYPEMONEY= 63
        KEYWDDATATYPESIGNEDBIGINTEGER= 64
        KEYWDDATATYPESIGNEDINTEGER= 65
        KEYWDDATATYPESIGNEDSMALLINTEGER= 66
        KEYWDDATATYPEUNSIGNEDBIGINTEGER= 67
        KEYWDDATATYPEUNSIGNEDINTEGER= 68
        KEYWDDATATYPEUNSIGNEDSMALLINTEGER= 69
        KEYWDDATATYPEUNSIGNEDTINYINTEGER= 70
        KEYWDDATATYPEOBJECTID= 71
        KEYWDDATATYPEROWID= 72
        KEYWDDATATYPERAWDATAFIXEDLENGTH= 73
        KEYWDDATATYPERAWDATALARGELENGTH= 74
        KEYWDDATATYPERAWDATAOLEOBJECT= 75
        KEYWDDATATYPERAWDATA= 76
        KEYWDDATATYPERAWDATAVARIABLELENGTH= 77
        KEYWDDATATYPEAUTOTIMESTAMP= 78
        KEYWDDATATYPEDATE= 79
        KEYWDDATATYPEDATETIME= 80
        KEYWDDATATYPETIME= 81
        KEYWDDATATYPESTRINGFIXEDLENGTH= 82
        KEYWDDATATYPESTRINGLARGELENGTH= 83
        KEYWDDATATYPESTRINGVARIABLELENGTH= 84
        KEYWDISACONCEPT= 85
        KEYWDISIDENTIFIEDBYITS= 86
        KEYWDISWRITTENAS= 87
        KEYWDNL     = 88
        KEYWDONE    = 89
        KEYWDREADING= 90
