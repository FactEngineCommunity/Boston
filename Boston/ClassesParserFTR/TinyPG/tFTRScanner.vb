...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        'Non terminal tokens:
        BINARYPREDICATECLAUSE= 2
        FACTREADING = 3
        FRONTREADINGTEXTCLAUSE= 4
        MODELELEMENT= 5
        PREDICATECLAUSE= 6
        UNARYPREDICATECLAUSE= 7
        Start       = 8

        'Terminal tokens:
        EOF         = 9
        FOLLOWINGREADINGTEXT= 10
        FRONTREADINGTEXT= 11
        MODELELEMENTNAME= 12
        PREDICATEPART= 13
        PREDICATESPACE= 14
        PREBOUNDREADINGTEXT= 15
        POSTBOUNDREADINGTEXT= 16
        SUBSCRIPT   = 17
        UNARYPREDICATEPART= 18
        WHITESPACE  = 19
    End Enum
