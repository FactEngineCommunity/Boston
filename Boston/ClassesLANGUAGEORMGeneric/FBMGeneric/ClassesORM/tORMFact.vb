...
Namespace FBM
    ...
    Public Class Fact
        ...
        Public Sub New(ByRef arFactType As FBM.FactType)
        ...
        Public Sub New(ByVal as_fact_id As String, ByRef arFactType As FBM.FactType)

            Call Me.New()
            Me.Model = arFactType.Model
            Me.Id = Trim(as_fact_id)
        ...
        Public Overridable Overloads Function Clone(ByRef arFactType As FBM.FactType) As Object

            Dim lrFact As New FBM.Fact
            Dim lrFactData As FBM.FactData

            With Me
                lrFact.Model = New FBM.Model
                lrFact.Model = .Model
                lrFact.Id = .Id
                lrFact.Name = .Name
                ...
                For Each lrFactData In Me.Data
                    lrFact.Data.Add(lrFactData.Clone)
                Next
