...
#Region "ParseNode"
	...
	End Sub 
        ...
        Friend Function Eval(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            ...
            Select Case Token.Type
                ...
                Case TokenType.UPDATESTMT
                    ...
                    Exit Select
                Case TokenType.UPSERTSTMT
                    Value = EvalUPSERTSTMT(tree, paramlist)
                    Exit Select
        ...
        Protected Overridable Function EvalUPSERTSTMT(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
