...
#Region "Parser"
    ...
    Public Function Parse(ByVal input As String) As ParseTree
        ...
        Private Sub ParseREMOVEMODELELEMENTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: REMOVEMODELELEMENTSTMT
            Dim tok As Token
            Dim n As ParseNode
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: REMOVEMODELELEMENTSTMT
        ...
        Private Sub ParseUPSERTSTMT(ByVal parent As ParseNode) ' NonTerminalSymbol: UPSERTSTMT
            Dim tok As Token
            Dim n As ParseNode
            Dim node As ParseNode = parent.CreateNode(m_scanner.GetToken(TokenType.UPSERTSTMT), "UPSERTSTMT")
            parent.Nodes.Add(node)


             ' Concat Rule
            tok = m_scanner.Scan(TokenType.KEYWDUPSERT) ' Terminal Rule: KEYWDUPSERT
            n = node.CreateNode(tok, tok.ToString() )
            node.Token.UpdateRange(tok)
            node.Nodes.Add(n)
            If tok.Type <> TokenType.KEYWDUPSERT Then
                m_tree.Errors.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDUPSERT.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDUPSERT"))
                Return
            ...
            m_tree.Optionals.Clear()
            End If
        End Sub ' NonTerminalSymbol: UPSERTSTMT
        ...
        Private Sub ParseStart(ByVal parent As ParseNode) ' NonTerminalSymbol: Start
            ...
            tok = m_scanner.LookAhead(TokenType.KEYWDADD, TokenType.KEYWDCREATE, TokenType.KEYWDCREATECONCEPT, TokenType.KEYWDCREATEMODEL, TokenType.KEYWDEXTEND, TokenType.KEYWDFOREACH, TokenType.KEYWDINSERT, TokenType.KEYWDUPSERT, TokenType.KEYWDITISMANDATORYTHAT, TokenType.KEYWDDELETE, TokenType.KEYWDDELETEALL, TokenType.KEYWDDELETEFACT, TokenType.KEYWDEXISTS, TokenType.KEYWDGET, TokenType.KEYWDOPEN, TokenType.KEYWDREMOVEINSTANCE, TokenType.KEYWDREMOVEMODELELEMENT, TokenType.KEYWDRENAMEINSTANCE, TokenType.KEYWDSELECT, TokenType.KEYWDUPDATE) ' Choice Rule
            Select Case tok.Type
             ' Choice Rule
            ...
            If m_tree.Errors.Count > 0 Then
                                ...
                                Exit Sub
            End If
                Case TokenType.KEYWDUPSERT
                    ParseUPSERTSTMT(node) ' NonTerminal Rule: UPSERTSTMT
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
            ...
            End If
                Case TokenType.KEYWDREMOVEMODELELEMENT
                    ParseREMOVEMODELELEMENTSTMT(node) ' NonTerminal Rule: REMOVEMODELELEMENTSTMT
            If m_tree.Errors.Count > 0 Then
                                parent.Token.UpdateRange(node.Token)
                                Exit Sub
            End If
            ...
            End If
                ...
                m_tree.Optionals.Add(New ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.KEYWDADD.ToString(), &H1001, 0, tok.StartPos, tok.StartPos, tok.EndPos - tok.StartPos, "KEYWDUPSERT"))
