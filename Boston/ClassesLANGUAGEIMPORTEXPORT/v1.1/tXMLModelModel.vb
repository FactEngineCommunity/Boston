...
Namespace XMLModel11
    ...
    Public Class Model
        ...
        <XmlAttribute()>
        Public XSDVersionNr As Double = 1.1
        Public ORMModel As New XMLModel11.ORMModel
        Public ORMDiagram As New List(Of XMLModel11.Page)
        ...
        Public Sub MapFromFBMModel(ByVal arFBMModel As FBM.Model)
            ...
            Me.ORMModel = New XMLModel11.ORMModel
            ...
            Dim lrXMLValueType As XMLModel11.ValueType
            For Each lrValueType In arFBMModel.ValueType

                lrXMLValueType = New XMLModel11.ValueType
            ...
            Dim lrXMLEntityType As XMLModel11.EntityType

            For Each lrEntityType In arFBMModel.EntityType

                lrXMLEntityType = New XMLModel11.EntityType
                ...
                Dim lrXMLSubtypeRelationship As XMLModel11.SubtypeRelationship

                For Each lrSubtypeRelationship In lrEntityType.SubtypeRelationship

                    lrXMLSubtypeRelationship = New XMLModel11.SubtypeRelationship
            ...
            Dim lrXMLFactType As XMLModel11.FactType

            For Each lrFactType In arFBMModel.FactType

                lrXMLFactType = New XMLModel11.FactType
                ...
                Dim lrXMLRole As XMLModel11.Role
                For Each lrRole In lrFactType.RoleGroup

                    lrXMLRole = New XMLModel11.Role
                ...
                Dim lrXMLFact As XMLModel11.Fact
                Dim lrFactData As FBM.FactData
                Dim lrXMLFactData As XMLModel11.FactData

                For Each lrFact In lrFactType.Fact

                    lrXMLFact = New XMLModel11.Fact
                    ...
                    For Each lrFactData In lrFact.Data
                        lrXMLFactData = New XMLModel11.FactData
                ...
                Dim lrXMLFactTypeReading As XMLModel11.FactTypeReading
                Dim lrPredicatePart As FBM.PredicatePart
                Dim lrXMLPredicatePart As XMLModel11.PredicatePart

                For Each lrFactTypeReading In lrFactType.FactTypeReading

                    lrXMLFactTypeReading = New XMLModel11.FactTypeReading

                    lrXMLFactTypeReading.Id = lrFactTypeReading.Id

                    For Each lrPredicatePart In lrFactTypeReading.PredicatePart

                        lrXMLPredicatePart = New XMLModel11.PredicatePart
            ...
            Dim lrXMLRoleConstraint As XMLModel11.RoleConstraint
            Dim lrRoleConstraintRole As FBM.RoleConstraintRole
            Dim lrXMLRoleConstraintRole As XMLModel11.RoleConstraintRole

            For Each lrRoleConstraint In arFBMModel.RoleConstraint

                lrXMLRoleConstraint = New XMLModel11.RoleConstraint
                ...
                For Each lrRoleConstraintRole In lrRoleConstraint.RoleConstraintRole
                    ...
                    lrXMLRoleConstraintRole = New XMLModel11.RoleConstraintRole
            ...
            Dim lrXMLModelNote As XMLModel11.ModelNote

            For Each lrModelNote In arFBMModel.ModelNote

                lrXMLModelNote = New XMLModel11.ModelNote
            ...
            For Each lrPage In arFBMModel.Page
                ...
                Dim lrExportPage As New XMLModel11.Page
        ...
        Public Sub MapToFBMPages(ByRef arModel As FBM.Model)
            ...
            Dim lrPage As FBM.Page
            Dim lrXMLPage As XMLModel11.Page
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType) 'As List(Of FBM.Fact)
            ...
            Try
                ...
                Dim lrXMLFact As XMLModel11.Fact
                Dim lrXMLFactData As XMLModel11.FactData
                Dim lrXMLFactType As New XMLModel11.FactType
