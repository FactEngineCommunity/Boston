...
Namespace XMLModel14
    ...
    Public Class FactType
        Implements IEquatable(Of XMLModel14.FactType)
        ...
        Private _RoleGroup As New List(Of XMLModel14.Role)
        Public Property RoleGroup() As List(Of XMLModel14.Role)
            Get
                Return Me._RoleGroup
            End Get
            Set(ByVal value As List(Of XMLModel14.Role))
                Me._RoleGroup = value
            End Set
        End Property

        <DebuggerBrowsable(DebuggerBrowsableState.Never)>
        Private _Facts As New List(Of XMLModel14.Fact)
        Public Property Facts() As List(Of XMLModel14.Fact)
            Get
                Return Me._Facts
            End Get
            Set(ByVal value As List(Of XMLModel14.Fact))
                Me._Facts = value
            End Set
        End Property

        <DebuggerBrowsable(DebuggerBrowsableState.Never)>
        Private _FactTypeReadings As New List(Of XMLModel14.FactTypeReading)
        Public Property FactTypeReadings() As List(Of XMLModel14.FactTypeReading)
            Get
                Return Me._FactTypeReadings
            End Get
            Set(ByVal value As List(Of XMLModel14.FactTypeReading))
