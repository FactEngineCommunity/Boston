...
Namespace XMLModel
    ...
    Public Class RootObjectType
        ...
        ''' <summary>
        ''' The .Id of the ModelElement (ObjectType) in Boston.
        ''' 
        ''' NB NORMA uses a .ref to a NORMAReferenceId for the ObjectType. Boston does not store NORMA .ref values but uses the unique FOL Id/Name of the ObjectType.
        ''' </summary>
        ''' <returns></returns>
        <XmlAttribute("ModelElementId")>
