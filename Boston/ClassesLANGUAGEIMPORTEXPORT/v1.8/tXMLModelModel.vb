...
Namespace XMLModel
    ...
    Public Class Model
        ...
        Public FBMModel As New XMLModel.FBMModel
        Public FBMDiagram As New List(Of XMLModel.Page)
        ...
        Public Function MapFromFBMModel(ByVal arFBMModel As FBM.Model, Optional ByVal abExcludedMDAModelElements As Boolean = False) As Boolean
            ...
            Try
                ...
                Me.FBMModel = New XMLModel.FBMModel
                Me.FBMModel.ModelId = arFBMModel.ModelId
                Me.FBMModel.Name = arFBMModel.Name
                Me.FBMModel.CoreVersionNumber = arFBMModel.CoreVersionNumber
...
#Region "ValueTypes"
                ...
                For Each lrValueType In arFBMModel.ValueType
                    ...
                    Me.FBMModel.ValueTypes.Add(lrXMLValueType)
...
#Region "EntityTypes"
                ...
                For Each lrEntityType In arFBMModel.EntityType
                    ...
                    Me.FBMModel.EntityTypes.Add(lrXMLEntityType)
...
#End Region
                    ...
                    For Each lrRole In lrFactType.RoleGroup
                        ...
                        lrXMLRole.JoinedObjectType = Me.FBMModel.getModelElementById(lrXMLRole.JoinedObjectTypeId)
...
#End Region
                    ...
                    Me.FBMModel.FactTypes.Add(lrXMLFactType)
...
#End Region
                ...
                Me.FBMModel.FactTypes.Sort(Function(x, y) x.IsLinkFactType.CompareTo(y.IsLinkFactType))
...
#Region "RoleConstraints"
                ...
                For Each lrRoleConstraint In arFBMModel.RoleConstraint
                    ...
                    Me.FBMModel.RoleConstraints.Add(lrXMLRoleConstraint)
...
#Region "ModelNotes"
                ...
                For Each lrModelNote In arFBMModel.ModelNote
                    ...
                    Me.FBMModel.ModelNotes.Add(lrXMLModelNote)
                Next
#End Region
...
#Region "Functions"
                ...
                For Each lrFunction In arFBMModel.Function
                    ...
                    Me.FBMModel.Functions.Add(lrXMLFunction)
                Next
...
#Region "Synonyms"
                For Each lrSynonym In arFBMModel.Synonyms
                    ...
                    Me.FBMModel.Synonyms.Add(New XMLModel.Synonym(lrSynonym.BaseTermModelElement.Id, lrSynonym.Synonym))
...
#Region "Pages"
                ...
                For Each lrPage In arFBMModel.Page
                    ...
                    Me.FBMDiagram.Add(lrExportPage)
                Next
#End Region
        ...
        Public Function MapToFBMModel(Optional ByRef arModel As FBM.Model = Nothing,
            ...
            Try
                ...
                If arModel IsNot Nothing Then
                    lrModel = arModel
                    lrModel.ModelId = Me.FBMModel.ModelId
                    lrModel.Name = Me.FBMModel.Name
                Else
                    lrModel = New FBM.Model(pcenumLanguage.ORMModel, Me.FBMModel.Name, Me.FBMModel.ModelId)
                End If
                ...
                lrModel.CoreVersionNumber = Me.FBMModel.CoreVersionNumber
...
#Region "ValueTypes"
                ...
                For Each lrXMLValueType In Me.FBMModel.ValueTypes
...
#Region "EntityTypes"
                ...
                For Each lrXMLEntityType In Me.FBMModel.EntityTypes
...
#Region "FactTypes"
                ...
                For Each lrXMLFactType In Me.FBMModel.FactTypes
...
#Region "Role Cleanup"
                ...
                For Each lrRole In larRole
                    ...
                    Dim lrXMLRole = From FactType In Me.FBMModel.FactTypes
                                    From Role In FactType.RoleGroup
...
#Region "Subtype Relationships"
                Dim larSubtypeRelationshipFactTypes = From FactType In Me.FBMModel.FactTypes
                    ...
                    Try
                        ...
                        Select Case lrModelElement.GetType
                            Case Is = GetType(FBM.EntityType)
                                Dim larSubtypeRelationship = From EntityType In Me.FBMModel.EntityTypes
                            ...
                            Case Is = GetType(FBM.ValueType)
                                Dim larSubtypeRelationship = From ValueType In Me.FBMModel.ValueTypes
                            ...
                            Case Is = GetType(FBM.FactType)
                                Dim larSubtypeRelationship = From FactType In Me.FBMModel.FactTypes
...
#Region "Role Constraints"
                ...
                For Each lrXMLRoleConstraint In Me.FBMModel.RoleConstraints
...
#Region "Model Notes"
                ...
                For Each lrXMLModelNote In Me.FBMModel.ModelNotes
...
#Region "Functions"
                ...
                For Each lrXMLFunction In Me.FBMModel.Functions
...
#End Region
                ...
                '======================
#Region "Synonymns"
                For Each lrXMLSynonym In Me.FBMModel.Synonyms
        ...
        Public Sub MapToFBMPages(ByRef arModel As FBM.Model,
            ...
            Try
                If My.Settings.ModelingUseThreadedXMLPageLoading Then
                    Parallel.ForEach(Me.FBMDiagram,
                ...
                Else
                    ...
                    For Each lrXMLPage In Me.FBMDiagram
                        lrPage = lrModel.Page.Find(Function(x) x.PageId = lrXMLPage.Id)
                        If lrPage Is Nothing Then
                            lrPage = Me.MapToFBMPage(lrXMLPage, lrModel,,,, True)
                        Else
        ...
        Public Function MapToNORMAORMModel(Optional ByRef arNORMADocument As NORMA.ORMDocument = Nothing,
            ...
            Try
                ...
                If arNORMADocument IsNot Nothing Then
                    ...
                    lrNORMAModel.Id = "_" & Me.FBMModel.ModelId.ToUpper()
                    lrNORMAModel.Name = Me.FBMModel.Name
                Else
                    lrNORMAModel = New NORMA.ORMModel(Me.FBMModel.ModelId.ToUpper(), Me.FBMModel.Name)
                End If
...
#Region "Create ALLCAPS Ids"
                For Each lrFBMValueType In Me.FBMModel.ValueTypes
                    lrFBMValueType.GUID = System.Guid.NewGuid.ToString.ToUpper
                Next
                For Each lrFBMEntityType In Me.FBMModel.EntityTypes
                ...
                Next
                For Each lrFBMFactType In Me.FBMModel.FactTypes
                    ...
                    Next
                Next
                For Each lrFBMRoleConstraint In Me.FBMModel.RoleConstraints
...
#Region "Objectification"
                        ...
                        If lrObjectifiedType IsNot Nothing Then
                            ...
                            Dim larFBMPreferredIdentifer = (From InternalUniquenssConstraint In Me.FBMModel.RoleConstraints
...
#Region "Ring Constraint"
                            ...
                            For Each lrFBMRoleConstraintRole In lrFBMRoleConstraint.RoleConstraintRoles
                                ...
                                Dim lrFBMFactTypeAndRole = (From FactType In Me.FBMModel.FactTypes
                                                            From Role In FactType.RoleGroup
...
#Region "External Uniqueness Constraint"
                            ...
                            Try
                                ...
                                For Each lrFBMRoleConstraintRole In lrFBMRoleConstraint.RoleConstraintRoles
                                    ...
                                    Dim larFactType = From FactType In Me.FBMModel.FactTypes
...
#Region "Role Value Constraint"
                            ...
                            Dim lrFBMRole = (From FactType In Me.FBMModel.FactTypes
                                             From Role In FactType.RoleGroup
...
#End Region
        ...
        Public Sub GetNORMASubtypeDetails(ByRef arNORMADocument As NORMA.ORMDocument,
            ...
            For Each lrFBMRole In arFBMFactType.RoleGroup
                ...
                lrFBMRole.JoinedObjectType = Me.FBMModel.getModelElementById(lrFBMRole.JoinedObjectTypeId)
...
#End Region 'Fact Type Readings
        ...
        Public Sub MapToORMDiagrams(ByRef arORMDocument As NORMA.ORMDocument,
            ...
            Try
                ...
                For Each lrFBMPage In Me.FBMDiagram
                    lrPage = Nothing
...
#Region "EntityTypeInstances"
                ...
                For Each lrConceptInstance In arXMLPage.ConceptInstance.FindAll(Function(x) x.ConceptType = pcenumConceptType.EntityType)
                    Try
                        Dim lrFBMEntityType As XMLModel.EntityType = Me.FBMModel.EntityTypes.Find(Function(x) x.Id = lrConceptInstance.Symbol)
...
#Region "FactTypeInstances"
                ...
                For Each lrConceptInstance In arXMLPage.ConceptInstance.FindAll(Function(x) x.ConceptType = pcenumConceptType.FactType)
                    ...
                    Try
                        Dim lrFBMFactType = Me.FBMModel.FactTypes.Find(Function(x) x.Id = lrConceptInstance.Symbol)
...
#Region "RoleConstraint"
                For Each lrConceptInstance In arXMLPage.ConceptInstance.FindAll(Function(x) x.ConceptType = pcenumConceptType.RoleConstraint)
                    Try
                        Dim lrFBMRoleConstraint = Me.FBMModel.RoleConstraints.Find(Function(x) x.Id = lrConceptInstance.Symbol)
...
#End Region
                ...
                If aoBackgroundWorker IsNot Nothing Then aoBackgroundWorker.ReportProgress(70 + CInt(29 * (arORMDocument.ORMDiagram.Count / Me.FBMDiagram.Count)))
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType,
            ...
            Try
                ...
                If arXMLFactType Is Nothing Then
                    lrXMLFactType = Me.FBMModel.FactTypes.Find(Function(x) x.Id = lsFactTypeId)
                Else
