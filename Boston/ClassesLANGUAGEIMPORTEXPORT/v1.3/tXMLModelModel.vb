...
Namespace XMLModel13
    ...
    Public Class Model
        ...
        <XmlAttribute()> _
        Public XSDVersionNr As Double = 1.3
        Public ORMModel As New XMLModel13.ORMModel
        Public ORMDiagram As New List(Of XMLModel13.Page)
        ...
        Public Sub MapFromFBMModel(ByVal arFBMModel As FBM.Model)
            ...
            Me.ORMModel = New XMLModel13.ORMModel
            ...
            Dim lrXMLValueType As XMLModel13.ValueType
            For Each lrValueType In arFBMModel.ValueType

                lrXMLValueType = New XMLModel13.ValueType
            ...
            Dim lrXMLEntityType As XMLModel13.EntityType

            For Each lrEntityType In arFBMModel.EntityType

                lrXMLEntityType = New XMLModel13.EntityType
                ...
                Dim lrXMLSubtypeRelationship As XMLModel13.SubtypeRelationship

                For Each lrSubtypeRelationship In lrEntityType.SubtypeRelationship

                    lrXMLSubtypeRelationship = New XMLModel13.SubtypeRelationship
            ...
            Dim lrXMLFactType As XMLModel13.FactType

            For Each lrFactType In arFBMModel.FactType

                lrXMLFactType = New XMLModel13.FactType
                ...
                Dim lrXMLRole As XMLModel13.Role
                For Each lrRole In lrFactType.RoleGroup

                    lrXMLRole = New XMLModel13.Role
                ...
                Dim lrXMLFact As XMLModel13.Fact
                Dim lrFactData As FBM.FactData
                Dim lrXMLFactData As XMLModel13.FactData

                For Each lrFact In lrFactType.Fact

                    lrXMLFact = New XMLModel13.Fact
                    ...
                    For Each lrFactData In lrFact.Data
                        lrXMLFactData = New XMLModel13.FactData
                ...
                Dim lrXMLFactTypeReading As XMLModel13.FactTypeReading
                Dim lrPredicatePart As FBM.PredicatePart
                Dim lrXMLPredicatePart As XMLModel13.PredicatePart

                For Each lrFactTypeReading In lrFactType.FactTypeReading

                    lrXMLFactTypeReading = New XMLModel13.FactTypeReading
                    ...
                    For Each lrPredicatePart In lrFactTypeReading.PredicatePart
                        ...
                        lrXMLPredicatePart = New XMLModel13.PredicatePart
            ...
            Dim lrXMLRoleConstraint As XMLModel13.RoleConstraint
            Dim lrRoleConstraintRole As FBM.RoleConstraintRole
            Dim lrRoleConstraintArgument As FBM.RoleConstraintArgument
            Dim lrXMLRoleConstraintRole As XMLModel13.RoleConstraintRole
            Dim lrXMLRoleConstraintArgument As XMLModel13.RoleConstraintArgument

            For Each lrRoleConstraint In arFBMModel.RoleConstraint

                lrXMLRoleConstraint = New XMLModel13.RoleConstraint
                ...
                For Each lrRoleConstraintRole In lrRoleConstraint.RoleConstraintRole
                    ...
                    lrXMLRoleConstraintRole = New XMLModel13.RoleConstraintRole
                ...
                '----------------------------------------
                Dim lrXMLRoleReference As XMLModel13.RoleReference
                Dim lrRole As FBM.Role
                For Each lrRoleConstraintArgument In lrRoleConstraint.Argument
                    lrXMLRoleConstraintArgument = New XMLModel13.RoleConstraintArgument
            ...
            Dim lrXMLModelNote As XMLModel13.ModelNote

            For Each lrModelNote In arFBMModel.ModelNote

                lrXMLModelNote = New XMLModel13.ModelNote
            ...
            For Each lrPage In arFBMModel.Page
                ...
                Dim lrExportPage As New XMLModel13.Page
        ...
        Public Sub MapToFBMPages(ByRef arModel As FBM.Model)
            ...
            Dim lrPage As FBM.Page
            Dim lrXMLPage As XMLModel13.Page
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType) 'As List(Of FBM.Fact)
            ...
            Try
                ...
                Dim lrXMLFact As XMLModel13.Fact
                Dim lrXMLFactData As XMLModel13.FactData
                Dim lrXMLFactType As New XMLModel13.FactType
