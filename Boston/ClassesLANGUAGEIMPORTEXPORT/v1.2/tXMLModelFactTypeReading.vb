...
Namespace XMLModel12
    ...
    Public Class FactTypeReading
        ...
        Private _PredicateParts As New List(Of XMLModel12.PredicatePart)
        Public Property PredicateParts() As List(Of XMLModel12.PredicatePart)
            Get
                Return Me._PredicateParts
            End Get
            Set(ByVal value As List(Of XMLModel12.PredicatePart))
