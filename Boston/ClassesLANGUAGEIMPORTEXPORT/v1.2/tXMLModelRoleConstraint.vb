...
Namespace XMLModel12
    ...
    Public Class RoleConstraint
        ...
        Private _RoleConstraintRoles As New List(Of XMLModel12.RoleConstraintRole)
        Public Property RoleConstraintRoles() As List(Of XMLModel12.RoleConstraintRole)
            Get
                Return Me._RoleConstraintRoles
            End Get
            Set(ByVal value As List(Of XMLModel12.RoleConstraintRole))
                Me._RoleConstraintRoles = value
            End Set
        End Property

        <DebuggerBrowsable(DebuggerBrowsableState.Never)>
        Private _Argument As New List(Of XMLModel12.RoleConstraintArgument)
        Public Property Argument As List(Of XMLModel12.RoleConstraintArgument)
            Get
                Return Me._Argument
            End Get
            Set(value As List(Of XMLModel12.RoleConstraintArgument))
                Me._Argument = value
            End Set
        End Property
