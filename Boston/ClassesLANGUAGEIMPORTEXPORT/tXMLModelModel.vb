    ...
    Public Class Model
        ...
        Public Sub MapFromFBMModel(ByVal arFBMModel As FBM.Model)
            ...
            For Each lrEntityType In arFBMModel.EntityType
                ...
                If IsSomething(lrEntityType.ReferenceModeRoleConstraint) Then
                    lrXMLEntityType.ReferenceModeRoleConstraintId = lrEntityType.ReferenceModeRoleConstraint.Id
                End If
                ...
                Dim lrSubtypeRelationship As FBM.tSubtypeConstraint
                Dim lrXMLSubtypeRelationship As XMLModel.SubtypeRelationship

                For Each lrSubtypeRelationship In lrEntityType.SubtypeConstraint
            ...
            For Each lrFactType In arFBMModel.FactType
                ...
                lrXMLFactType.IsPreferredReferenceModeFT = lrFactType.IsPreferredReferenceMode
                lrXMLFactType.IsSubtypeRelationshipFactType = lrFactType.IsSubtypeConstraintFactType
                ...
                Dim lrPredicatePart As FBM.tPredicatePart
                ...
                For Each lrFactTypeReading In lrFactType.FactTypeReading
                    ...
                    For Each lrPredicatePart In lrFactTypeReading.PredicatePart
                        ...
                        lrXMLPredicatePart.ObjectType1Id = lrPredicatePart.ObjectType1.Id
                        lrXMLPredicatePart.ObjectType2Id = lrPredicatePart.ObjectType2.Id
        ...
        Public Function MapToFBMModel() As FBM.Model
            ...
            For Each lrXMLEntityType In Me.ORMModel.EntityTypes
                ...
                lrEntityType.PreferredIdentifierRCId = lrXMLEntityType.ReferenceModeRoleConstraintId
            ...
            For Each lrXMLRoleConstraint In Me.ORMModel.RoleConstraints
                ...
                'lrRoleConstraint.ShortDescription = Trim(vievlibrary.NullVal(lREcordset("ShortDescription").Value, ""))
                'lrRoleConstraint.LongDescription = Trim(vievlibrary.NullVal(lREcordset("LongDescription").Value, ""))
                ...
                'lrRoleConstraint.LevelNr = lrXMLRoleConstraint.LevelNr
                ...
                'Link to the Concept within the ModelDictionary
                '------------------------------------------------
                Dim lrDictionaryEntry As New FBM.DictionaryEntry(lrModel, lrRoleConstraint.Id, pcenumConceptType.RoleConstraint, lrRoleConstraint.ShortDescription, lrRoleConstraint.LongDescription)
                lrDictionaryEntry = lrModel.AddModelDictionaryEntry(lrDictionaryEntry)
                ...
                If lrRoleConstraint.RoleConstraintRole.Count = 0 Then
                    prRichmondApplication.ThrowErrorMessage("No RoleConstraintRoles found for RoleConstraint.Id: " & lrRoleConstraint.Id, pcenumErrorType.Information)
                Else
            ...
            For Each lrXMLModelNote In Me.ORMModel.ModelNotes
                ...
                'lrModelNote.ShortDescription = Trim(VievLibrary.NullVal(lRecordset("ShortDescription").Value, ""))
                'lrModelNote.LongDescription = Trim(VievLibrary.NullVal(lRecordset("LongDescription").Value, ""))
        ...
        Public Sub MapToFBMPages(ByRef arModel As FBM.Model)
            ...
            For Each lrXMLPage In Me.ORMDiagram
                ...
                For Each lrConceptInstance In lrXMLPage.ConceptInstance.FindAll(Function(x) x.ConceptType = pcenumConceptType.FactType)
                    ...
                    lrPage.FactTypeInstance.Add(lrFactTypeInstance)
                Next
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType) 'As List(Of FBM.Fact)
            ...
            Catch ex As Exception
                ...
                prRichmondApplication.ThrowErrorMessage(lsMessage2, pcenumErrorType.Critical, ex.StackTrace)
            End Try
        ...
        Public Sub GetFactTypeDetails(ByRef arFactType As FBM.FactType)
            ...
            'arFactType.ShortDescription = Trim(VievLibrary.NullVal(lREcordset("ShortDescription").Value, ""))
            'arFactType.LongDescription = Trim(VievLibrary.NullVal(lREcordset("LongDescription").Value, ""))
            arFactType.IsObjectified = lrXMLFactType.IsObjectified
            'arFactType.IsCoreFactType = CBool(lREcordset("IsCoreFactType").Value)
            arFactType.IsPreferredReferenceMode = lrXMLFactType.IsPreferredReferenceModeFT
            arFactType.IsSubtypeConstraintFactType = lrXMLFactType.IsSubtypeRelationshipFactType
        ...
        Public Function GetFactTypeReadingsForFactType(ByRef arFactType As FBM.FactType) As List(Of FBM.FactTypeReading)
            ...
            Try
                ...
                For Each lrXMLFactTypeReading In lrXMLFactType.FactTypeReadings
                    ...
                    For Each lrXMLPredicatePart In lrXMLFactTypeReading.PredicateParts
                        ...
                        lrPredicatePart = New FBM.tPredicatePart(arFactType.Model, lrFactTypeReading)
                        lrPredicatePart.SequenceNr = lrXMLPredicatePart.SequenceNr
                        lrPredicatePart.ObjectType1 = New FBM.ModelObject(lrXMLPredicatePart.ObjectType1Id)
                        lrPredicatePart.ObjectType2 = New FBM.ModelObject(lrXMLPredicatePart.ObjectType2Id)
                    ...
                    '------------------------------------------------------
                    'Construct the FactTypeReading.ObjectTypeList 
                    '  from the PredicatePart list for the FactTypeReading
                    '------------------------------------------------------
                    ...
                    For Each lrPredicatePart In lrFactTypeReading.PredicatePart
                        liSequenceNr += 1
                        Select Case liSequenceNr
                            Case Is = 1
                                lr_orm_ObjectTypeList.Add(New FBM.ModelObject(lrPredicatePart.ObjectType1.Symbol))
                                lr_orm_ObjectTypeList.Add(New FBM.ModelObject(lrPredicatePart.ObjectType2.Symbol))
                            Case Else
                                lr_orm_ObjectTypeList.Add(New FBM.ModelObject(lrPredicatePart.ObjectType2.Symbol))
                        End Select
                    Next

                    lrFactTypeReading.ObjectTypeList = lr_orm_ObjectTypeList
            ...
            Catch ex As Exception
                ...
                prRichmondApplication.ThrowErrorMessage(lsMessage1, pcenumErrorType.Critical, ex.StackTrace)
            End Try
