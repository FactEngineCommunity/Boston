...
Namespace XMLModel15
    ...
    Public Class RoleConstraint
        ...
        Private _RoleConstraintRoles As New List(Of XMLModel15.RoleConstraintRole)
        Public Property RoleConstraintRoles() As List(Of XMLModel15.RoleConstraintRole)
            Get
                Return Me._RoleConstraintRoles
            End Get
            Set(ByVal value As List(Of XMLModel15.RoleConstraintRole))
                Me._RoleConstraintRoles = value
            End Set
        End Property

        <DebuggerBrowsable(DebuggerBrowsableState.Never)>
        Private _Argument As New List(Of XMLModel15.RoleConstraintArgument)
        Public Property Argument As List(Of XMLModel15.RoleConstraintArgument)
            Get
                Return Me._Argument
            End Get
            Set(value As List(Of XMLModel15.RoleConstraintArgument))
                Me._Argument = value
            End Set
        End Property
