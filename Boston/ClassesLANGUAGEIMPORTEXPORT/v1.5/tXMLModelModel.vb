...
Namespace XMLModel15
    ...
    Public Class Model
        ...
        <XmlAttribute()> _
        Public XSDVersionNr As Double = 1.5
        Public ORMModel As New XMLModel15.ORMModel
        Public ORMDiagram As New List(Of XMLModel15.Page)
        ...
        Public Sub MapFromFBMModel(ByVal arFBMModel As FBM.Model)
            ...
            Try
                Me.ORMModel = New XMLModel15.ORMModel
                ...
                Dim lrXMLValueType As XMLModel15.ValueType
                For Each lrValueType In arFBMModel.ValueType

                    lrXMLValueType = New XMLModel15.ValueType
                ...
                Dim lrXMLEntityType As XMLModel15.EntityType

                For Each lrEntityType In arFBMModel.EntityType

                    lrXMLEntityType = New XMLModel15.EntityType
                    ...
                    For Each lrSubtypeRelationship In lrEntityType.SubtypeRelationship
                        ...
                        lrXMLSubtypeRelationship = New XMLModel15.SubtypeRelationship
                ...
                Dim lrXMLFactType As XMLModel15.FactType

                For Each lrFactType In arFBMModel.FactType

                    lrXMLFactType = New XMLModel15.FactType
                    ...
                    Dim lrXMLRole As XMLModel15.Role
                    For Each lrRole In lrFactType.RoleGroup

                        lrXMLRole = New XMLModel15.Role
                    ...
                    Dim lrXMLFact As XMLModel15.Fact
                    Dim lrFactData As FBM.FactData
                    Dim lrXMLFactData As XMLModel15.FactData

                    For Each lrFact In lrFactType.Fact

                        lrXMLFact = New XMLModel15.Fact
                        ...
                        For Each lrFactData In lrFact.Data
                            lrXMLFactData = New XMLModel15.FactData
                    ...
                    Dim lrXMLFactTypeReading As XMLModel15.FactTypeReading
                    Dim lrPredicatePart As FBM.PredicatePart
                    Dim lrXMLPredicatePart As XMLModel15.PredicatePart

                    For Each lrFactTypeReading In lrFactType.FactTypeReading

                        lrXMLFactTypeReading = New XMLModel15.FactTypeReading
                        ...
                        For Each lrPredicatePart In lrFactTypeReading.PredicatePart
                            ...
                            lrXMLPredicatePart = New XMLModel15.PredicatePart
                ...
                Dim lrXMLRoleConstraint As XMLModel15.RoleConstraint
                Dim lrRoleConstraintRole As FBM.RoleConstraintRole
                Dim lrRoleConstraintArgument As FBM.RoleConstraintArgument
                Dim lrXMLRoleConstraintRole As XMLModel15.RoleConstraintRole
                Dim lrXMLRoleConstraintArgument As XMLModel15.RoleConstraintArgument

                For Each lrRoleConstraint In arFBMModel.RoleConstraint

                    lrXMLRoleConstraint = New XMLModel15.RoleConstraint
                    ...
                    For Each lrRoleConstraintRole In lrRoleConstraint.RoleConstraintRole
                        ...
                        lrXMLRoleConstraintRole = New XMLModel15.RoleConstraintRole
                    ...
                    For Each lrRoleConstraintArgument In lrRoleConstraint.Argument
                        lrXMLRoleConstraintArgument = New XMLModel15.RoleConstraintArgument
                ...
                Dim lrXMLModelNote As XMLModel15.ModelNote

                For Each lrModelNote In arFBMModel.ModelNote

                    lrXMLModelNote = New XMLModel15.ModelNote
                ...
                For Each lrPage In arFBMModel.Page
                    ...
                    Dim lrExportPage As New XMLModel15.Page
        ...
        Public Sub MapToFBMPages(ByRef arModel As FBM.Model)
            ...
            Dim lrPage As FBM.Page
            Dim lrXMLPage As XMLModel15.Page
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType) 'As List(Of FBM.Fact)
            ...
            Try
                ...
                Dim lrXMLFact As XMLModel15.Fact
                Dim lrXMLFactData As XMLModel15.FactData
                Dim lrXMLFactType As New XMLModel15.FactType
