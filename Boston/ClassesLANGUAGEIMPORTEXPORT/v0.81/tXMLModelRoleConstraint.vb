...
Namespace XMLModelv081
    ...
    Public Class RoleConstraint
        ...
        <DebuggerBrowsable(DebuggerBrowsableState.Never)> _
        Private _RoleConstraintRoles As New List(Of XMLModelv081.RoleConstraintRole)
        Public Property RoleConstraintRoles() As List(Of XMLModelv081.RoleConstraintRole)
            Get
                Return Me._RoleConstraintRoles
            End Get
            Set(ByVal value As List(Of XMLModelv081.RoleConstraintRole))
