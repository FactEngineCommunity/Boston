...
Namespace XMLModelv081
    ...
    Public Class Model
        ...
        Public Sub MapFromFBMModel(ByVal arFBMModel As FBM.Model)
            ...
            Me.ORMModel = New XMLModelv081.ORMModel
            ...
            Dim lrXMLValueType As XMLModelv081.ValueType
            For Each lrValueType In arFBMModel.ValueType

                lrXMLValueType = New XMLModelv081.ValueType
            ...
            Dim lrXMLEntityType As XMLModelv081.EntityType

            For Each lrEntityType In arFBMModel.EntityType

                lrXMLEntityType = New XMLModelv081.EntityType
            ...
            Dim lrXMLFactType As XMLModelv081.FactType

            For Each lrFactType In arFBMModel.FactType

                lrXMLFactType = New XMLModelv081.FactType
                ...
                Dim lrXMLRole As XMLModelv081.Role
                For Each lrRole In lrFactType.RoleGroup

                    lrXMLRole = New XMLModelv081.Role
                ...
                Dim lrXMLFact As XMLModelv081.Fact
                Dim lrFactData As FBM.FactData
                Dim lrXMLFactData As XMLModelv081.FactData

                For Each lrFact In lrFactType.Fact

                    lrXMLFact = New XMLModelv081.Fact
                    ...
                    For Each lrFactData In lrFact.Data
                        lrXMLFactData = New XMLModelv081.FactData
                ...
                Dim lrXMLFactTypeReading As XMLModelv081.FactTypeReading
                Dim lrPredicatePart As FBM.PredicatePart
                Dim lrXMLPredicatePart As XMLModelv081.PredicatePart

                For Each lrFactTypeReading In lrFactType.FactTypeReading

                    lrXMLFactTypeReading = New XMLModelv081.FactTypeReading

                    lrXMLFactTypeReading.Id = lrFactTypeReading.Id

                    For Each lrPredicatePart In lrFactTypeReading.PredicatePart

                        lrXMLPredicatePart = New XMLModelv081.PredicatePart
            ...
            Dim lrXMLRoleConstraint As XMLModelv081.RoleConstraint
            Dim lrRoleConstraintRole As FBM.RoleConstraintRole
            Dim lrXMLRoleConstraintRole As XMLModelv081.RoleConstraintRole

            For Each lrRoleConstraint In arFBMModel.RoleConstraint

                lrXMLRoleConstraint = New XMLModelv081.RoleConstraint
                ...
                For Each lrRoleConstraintRole In lrRoleConstraint.RoleConstraintRole
                    ...
                    lrXMLRoleConstraintRole = New XMLModelv081.RoleConstraintRole
            ...
            Dim lrXMLModelNote As XMLModelv081.ModelNote

            For Each lrModelNote In arFBMModel.ModelNote

                lrXMLModelNote = New XMLModelv081.ModelNote
        ...
        Public Sub GetFactsForFactType(ByRef arFactType As FBM.FactType) 'As List(Of FBM.Fact)
            ...
            Try
                ...
                Dim lrXMLFact As XMLModelv081.Fact
                Dim lrXMLFactData As XMLModelv081.FactData
                Dim lrXMLFactType As New XMLModelv081.FactType
            ...
            Try
                ...
                For Each lrXMLFactTypeReading In lrXMLFactType.FactTypeReadings
                    ...
                    For Each lrXMLPredicatePart In lrXMLFactTypeReading.PredicateParts
                        ...
                        lrPredicatePart = New FBM.PredicatePart(arFactType.Model, lrFactTypeReading)
