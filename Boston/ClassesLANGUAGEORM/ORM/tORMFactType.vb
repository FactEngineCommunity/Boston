        ...
        Function GetOtherRoleOfBinaryFactType(ByVal asRoleId As String) As FBM.Role
            ...
            Try
                ...
                If Not Me.IsBinaryFactType() Then
                    Throw New System.Exception("Error: Non Binary Fact Type: " & Me.Id & ", Role: aiRoleId: " & asRoleId)
                End If
        ...
        Public Sub RemoveObjectification(ByVal abBroadcastInterfaceEvent As Boolean)
            ...
            Try
                ...
                If Me.IsManyTo1BinaryFactType Or Me.Is1To1BinaryFactType Then
                    ...
                    Call Me.Model.DoRDSProcessingForRoleConstraint(lrRole.InternalUniquenessConstraint(0), False, Nothing)
                ...
                If Me.IsManyTo1BinaryFactType Or Me.Is1To1BinaryFactType Then
                    Dim lrRDSRelationTable = Me.getCorrespondingRDSTable(Nothing, True)
                    If lrRDSRelationTable IsNot Nothing Then
