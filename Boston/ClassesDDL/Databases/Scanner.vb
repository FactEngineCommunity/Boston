...
#Region "Scanner"
    ...
    Partial Public Class Scanner
        ...
        Public Sub New()
            ...
            regex = new Regex("NUMBER", RegexOptions.Compiled)
            Patterns.Add(TokenType.KEYWDNUMBER, regex)
            Tokens.Add(TokenType.KEYWDNUMBER)
            ...
            Patterns.Add(TokenType.KEYWDCONSTRAINT, regex)
            Tokens.Add(TokenType.KEYWDCONSTRAINT)
...
#Region "Token"
    ...
    Public Enum TokenType
        ...
        COLUMNDEFINITION= 4
        dataType    = 5
        CONSTRAINTDEFINITION= 6
        primaryKeyConstraint= 7
        primaryKeyColumnList= 8
        foreignKeyConstraint= 9
        foreignKeyColumnList= 10
        Start       = 11
