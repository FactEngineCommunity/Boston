    ...
    Partial Public Class ParseNode 
        ...
        Friend Function Eval(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            ...
            Select Case Token.Type
                Case TokenType.ddl
                    Value = Evalddl(tree, paramlist)
                    Exit Select
                Case TokenType.createTableStatement
                    Value = EvalcreateTableStatement(tree, paramlist)
                    Exit Select
                Case TokenType.COLUMNDEFINITION
                    Value = EvalCOLUMNDEFINITION(tree, paramlist)
                    Exit Select
                Case TokenType.dataType
                    Value = EvaldataType(tree, paramlist)
                    Exit Select
                Case TokenType.CONSTRAINTDEFINITION
                    Value = EvalCONSTRAINTDEFINITION(tree, paramlist)
                    Exit Select
                Case TokenType.primaryKeyConstraint
                    Value = EvalprimaryKeyConstraint(tree, paramlist)
                    Exit Select
                Case TokenType.primaryKeyColumnList
                    Value = EvalprimaryKeyColumnList(tree, paramlist)
                    Exit Select
                Case TokenType.foreignKeyConstraint
                    Value = EvalforeignKeyConstraint(tree, paramlist)
                    Exit Select
                Case TokenType.foreignKeyColumnList
                    Value = EvalforeignKeyColumnList(tree, paramlist)
                    Exit Select
        ...
        End Function
                ...
                Protected Overridable Function Evalddl(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalcreateTableStatement(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalCOLUMNDEFINITION(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
        ...
        Protected Overridable Function EvalCONSTRAINTDEFINITION(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalprimaryKeyConstraint(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalprimaryKeyColumnList(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalforeignKeyConstraint(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function

        Protected Overridable Function EvalforeignKeyColumnList(ByVal tree As ParseTree, ByVal ParamArray paramlist As Object()) As Object
            Throw New NotImplementedException()
        End Function
